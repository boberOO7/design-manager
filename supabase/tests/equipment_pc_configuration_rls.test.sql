...
select throws_like($$update public.equipment set equipment_type = 'laptop' where id = '47000000-0000-0000-0000-000000000200'$$, '%equipment_pc_configuration_type%', 'PC configuration cannot be assigned to a laptop');
