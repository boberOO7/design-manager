...
select lives_ok($$select pg_temp.agreement(202,12,jsonb_build_object('id',pg_temp.result(200),'revision',2,'effectiveFrom',pg_temp.month(),'amount','1100','employeePayout','1100','employeeDeductions','0','employerCost','0','employerCostStatus','fixed'))$$,'settled future month does not block unpaid current correction');
