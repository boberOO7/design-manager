drop function public.update_studio_member_profile(uuid, text, text, text, date, date);
...
revoke all on function public.update_studio_member_profile(uuid, text, text, text, date, date, text, text, bigint) from public, anon;
grant execute on function public.update_studio_member_profile(uuid, text, text, text, date, date, text, text, bigint) to authenticated;
