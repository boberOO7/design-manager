-- A settled future month remains frozen without blocking an unpaid current month.
...
begin
  ...
  if schedule.kind='payroll' and exists(
    ...
    where o.studio_id=new.studio_id and o.schedule_id=new.schedule_id and o.period_start=new.effective_from
  ) then raise exception 'finance_schedule_effective_date'; end if;
  return new;
end $$;
