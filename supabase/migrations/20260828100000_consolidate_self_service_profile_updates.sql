...
revoke all on function public.update_my_profile_details(date, text, text, bigint) from public, anon;
grant execute on function public.update_my_profile_details(date, text, text, bigint) to authenticated;
