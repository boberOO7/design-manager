...
create function public.edit_finance_trip_entry(p_studio_id uuid,p_request_id uuid,p_trip_id uuid,p_entry_id uuid,p_input jsonb)
...
begin
  ...
  -- Keep the actual's planning relationship, including an already retired expectation.
  replacement:=(p_input-'reversesId')||jsonb_build_object('planId',original.plan_id);
