-- Security-invoker public RPCs cannot call the deliberately private
-- is_project_progress_stage helper. Keep its EXECUTE grant restricted and use
-- the helper's canonical stage predicate directly at this public boundary.
