...
## Summary
- 6923 nodes · 15359 edges · 448 communities (311 shown, 137 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 181 edges (avg confidence: 0.63)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `715ee76c`
...
1. `getActiveStudioMembership` - 65 edges
2. `createClient()` - 61 edges
3. `cn()` - 58 edges
4. `el()` - 51 edges
5. `runHook()` - 40 edges
6. `getActiveStudioAdmin()` - 37 edges
...
## Communities (448 total, 137 thin omitted)
...
Cohesion: 0.05
Nodes (71): isDateOnly(), isRecord(), parseDayOff(), POST(), PATCH(), POST(), PATCH(), PATCH() (+63 more)

### Community 3 - "task-status.ts"
Cohesion: 0.04
Nodes (73): PATCH(), PATCH(), PATCH(), PATCH(), PATCH(), createProjectTask(), deleteProjectTask(), revalidateMyTasks() (+65 more)
...
Cohesion: 0.05
Nodes (57): AccessUnavailablePage(), AppLayout(), generateMetadata(), geistMono, geistSans, viewport, SignOutButton(), AppHeader() (+49 more)
...
Cohesion: 0.05
Nodes (44): OfficeLayout(), ProjectMemberActionState, restoreStudioMember(), LeaderboardBonusSettings(), OfficeShell(), tabs, AddProjectMemberForm(), ProjectTeamSection() (+36 more)
...
Cohesion: 0.06
Nodes (46): TaskCollaboratorMultiSelect(), TaskDeadlineEditor(), makeFormValues(), TaskDetailsDrawer(), TaskEditResponse, TaskWorkResponse, AssignableProjectMember, getTaskStatusBadgeStyle() (+38 more)
...
Cohesion: 0.07
Nodes (44): Context, PATCH(), POST(), PATCH(), responseSchema, calendarQuery, route, Context (+36 more)

### Community 19 - "queries/index.ts"
Cohesion: 0.05
Nodes (39): dashboardMetrics, employeeWorkload, getAccessibleProjects(), getDashboardMetrics(), getEmployeeWorkload(), getMyTasks(), getProjectAreaProgress(), getProjectById() (+31 more)
...
Cohesion: 0.07
Nodes (52): applyConfigSource(), applyDetectorConfigSource(), applyPatchText(), canonicalPathCache, clampByte(), cloneDefaultConfig(), CO_SCAN_STYLE_NAMES, coLocatedStylesheets() (+44 more)
...
Cohesion: 0.08
Nodes (48): AgendaView(), MonthView(), CalendarEventRelevance, calendarItemTimestamp(), CalendarTimeOffTitleLabels, canAttendCalendarEvent(), compareCanonical(), DEFAULT_CALENDAR_FILTERS (+40 more)
...
Cohesion: 0.08
Nodes (37): ProfileAvatarEditor(), DeadlineSummary(), ProjectContextActions(), ProjectContextBand(), ProjectDeadlines(), calculateOverallProjectProgress(), calculatePersonalProgress(), calculateProjectProgress() (+29 more)
...
Cohesion: 0.08
Nodes (33): CalendarDetailHeaderIcon(), CalendarEventDetails(), CalendarPill(), dateLabel(), DayDetails(), Drawer, EventForm(), isCalendarItem() (+25 more)

### Community 38 - "team/actions.ts"
Cohesion: 0.09
Nodes (35): inviteEmployee(), isExistingAuthUserError(), removeStudioMember(), updateStudioMemberProfile(), InviteEmployeeForm(), StudioMemberProfileEditor(), getCountryOptions(), EmployeeInvitationActionState (+27 more)
...
Cohesion: 0.06
Nodes (35): globalStyles, InviteePicker(), canTransitionTimeOff(), RecurrenceRule, getTimeOffRequestPresentation(), requiresTimeOffReason(), TIME_OFF_REQUEST_PRESENTATION, TimeOffFieldLabelKey (+27 more)
...
Cohesion: 0.11
Nodes (30): formatArea(), LeaderboardPage(), LeaderboardBonusMenu(), LeaderboardPeriodSwitcher(), getLeaderboardBonusPercent(), getLeaderboardEntryBonusPercent(), hasLeaderboardBonuses(), allocateRemainingStageBudget() (+22 more)
...
Cohesion: 0.11
Nodes (26): DELETE(), PATCH(), POST(), PATCH(), MyTasksPage(), authorizeChecklistEdit(), createChecklistItem(), deleteChecklistItem() (+18 more)

### Community 57 - "project-task-board.tsx"
Cohesion: 0.07
Nodes (17): BoardColumn(), BulkAssignmentScope, BulkDragSource, formatTaskCount(), getColumnDropId(), interactiveSelector, keyboardSensor, pointerSensor (+9 more)
...
Cohesion: 0.16
Nodes (26): CalendarPage(), validDate(), CalendarWorkspace(), CalendarQueryInput, getCalendarData(), addCalendarDays(), deduplicateCalendarItems(), getCalendarRange() (+18 more)

### Community 66 - "cn"
Cohesion: 0.15
Nodes (16): SpaceLogoFull(), StudioFlowMark(), AppSidebar(), MobileNavigation(), ProjectNavigationLink(), MetricCard(), EmptyState(), Panel() (+8 more)

### Community 67 - "assignments-workspace.tsx"
Cohesion: 0.13
Nodes (20): AssignmentAdminControls(), AssignmentDetailDrawer(), AssignmentRow(), Filter, initialCreateState, statusStyle(), getAllowedOfficeAssignmentStatuses(), getPrimaryOfficeAssignmentStatus() (+12 more)
...
Cohesion: 0.14
Nodes (27): readExistingProjectFile(), shellCopiedFileContent(), appendDesignSystemNote(), bumpEditCount(), canonicalPath(), clampGroupedToBudget(), dedupeAgainstCache(), depthIsSet() (+19 more)
...
Cohesion: 0.17
Nodes (18): ProfileAvatarEditorProps, TeamMemberCard(), TeamMemberCardProps, sizeClassName, UserAvatar(), UserAvatarProps, UserAvatarSize, AvatarStorageRemover (+10 more)
...
Cohesion: 0.15
Nodes (18): Admin(), Deadlines(), Employee(), ProjectDetails(), DashboardSection(), MetricStrip(), metricToneClasses, OperationalSurface() (+10 more)
...
Cohesion: 0.13
Nodes (19): ProjectContextProject, ProjectWorkspace(), DraftStage, ProjectStageConfigurationDialog(), AccessibleProjectWithTasks, ProfileRow, ProjectListMembershipRow, ProjectListParticipant (+11 more)

### Community 99 - "lib/submissions.ts"
Cohesion: 0.15
Nodes (20): CommentRow, SubmissionItem, SubmissionRow, canRejectSubmission(), getAllowedNextStatuses(), getPrimarySubmissionAction(), getPrimarySubmissionStatus(), isSubmissionStatus() (+12 more)
...
Cohesion: 0.15
Nodes (18): ProjectSignals(), MyTasksList(), sections, ProjectHealth, badge(), getPriorityBadgeStyle(), getProjectHealthBadgeStyle(), getProjectLifecycleBadgeStyle() (+10 more)
...
Cohesion: 0.17
Nodes (18): ADVISORY_RULES, clampToBudget(), cleanIgnoreValueDisplay(), directiveFooter(), extractFindingIgnoreValue(), extractFindingIgnoreValueRaw(), extractMotionIgnoreValue(), filterFindings() (+10 more)
...
Cohesion: 0.15
Nodes (9): AdminPage(), ArchivePage(), AdministrationWorkspace(), ProjectStatusAction(), PageHeader(), ArchivedProject, ArchivedProjectsResult, getArchivedProjects() (+1 more)

### Community 133 - "queries/office-assignments.ts"
Cohesion: 0.17
Nodes (12): kyivToday(), OfficeAssignmentsPage(), kyivToday(), OfficeOverviewPage(), AssignmentsWorkspace(), AssignmentRow, getOfficeAssignmentsData(), OfficeAssignmentItem (+4 more)
...
### Community 158 - "Impeccable Asset Producer"
Cohesion: 0.14
...
Cohesion: 0.28
Nodes (7): ACK_EXTS, shouldEmitAckForFile(), extensionCache, LIVE_TEMPLATE_EXTENSIONS, matchConfiguredExtension(), mergeExtensions(), normalizeExtensionEntries()
...
Cohesion: 0.36
Nodes (5): ConnectionStatus, GoogleCalendarIntegration(), isConnectionStatus(), toConnectionStatus(), updateCachedConnectionStatus()
...
### Community 256 - "office-workspace.test.ts"
Cohesion: 0.29
...
Cohesion: 0.40
Nodes (4): OfficeSubmissionsPage(), SubmissionsWorkspace(), getSubmissionsData(), person()
...
### Community 293 - "public-table-privileges-migration.test.ts"
Cohesion: 0.50
...
### Community 305 - "secondary-foreground"
Cohesion: 0.67
...
## Knowledge Gaps
- **1770 isolated node(s):** `fs`, `path`, `fs`, `path`, `fs` (+1765 more)
...
- **Why does `handleKeyDown()` connect `setLiveState` to `live-browser.js`, `connectSSE`, `el`, `dialog.tsx`, `initGlobalBar`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `el()` connect `el` to `css-cascade.mjs`, `checks.mjs`, `live-browser.js`, `mountSvelteComponentVariant`, `connectSSE`, `setLiveState`, `injected/index.mjs`, `SAFE_TAGS`, `design-system.mjs`, `collectVisualContrastCandidates`, `detect-antipatterns-browser.js`, `constants.mjs`, `collectBrowserFindings`, `svelte-ast.mjs`, `initPageChat`, `initGlobalBar`, `detect-html.mjs`?**
  _High betweenness centrality (0.098) - this node is a cross-community bridge._
- **Why does `Dialog()` connect `dialog.tsx` to `project-workspace.tsx`, `assignments-workspace.tsx`, `project-template-manager.tsx`, `calendar-workspace.tsx`, `team/actions.ts`, `cn`, `setLiveState`, `button.tsx`, `submissions-workspace.tsx`, `profile-avatar-editor.tsx`, `contractor-directory.tsx`, `google-calendar-integration.tsx`, `task-details-drawer.tsx`?**
...
- **Should `checks.mjs` be split into smaller, more focused modules?**
  _Cohesion score 0.03713830029619503 - nodes in this community are weakly interconnected._