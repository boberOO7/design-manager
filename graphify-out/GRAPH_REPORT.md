# Graph Report - design-manager  (2026-09-23)

## Corpus Check
- 1190 files · ~945,110 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9711 nodes · 21025 edges · 753 communities (543 shown, 210 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 203 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4981d3e6`
...
- trip-entry-editor.tsx
- lib/calendar.ts
- injected/index.mjs
- profile-editor-dialog.tsx
...
- detect-url.mjs
- (app)/layout.tsx
- private.sync_calendar_finance_trip
- generate-slide.py
...
- 20260922091623_finance_business_trips.sql
...
- public.record_finance_trip_entry
- finance-planning.ts
- productivity.ts
- Messaging Framework
...
- 20260922194947_task_status_history.sql
...
- equipment-history.integration.test.ts
...
- main
- finance-forecast.spec.ts
- finance-opening-valuation.spec.ts
- translation-payload.spec.ts
- finance-payroll-setup.spec.ts
- profile-shell.spec.ts
...
- task-status-history-migration.test.ts
...
1. `createClient()` - 210 edges
2. `Finance` - 156 edges
3. `Database` - 108 edges
4. `cn()` - 106 edges
5. `getActiveStudioAdmin()` - 105 edges
...
- `moveFinanceRules()` --implements--> `Recurring payment groups`  [INFERRED]
  src/app/(app)/finance/schedules/actions.ts → docs/architecture/finance.md
...
- `TripEntryEditor` --implements--> `Inline trip entry editing`  [INFERRED]
  src/components/finance/trip-entry-editor.tsx → docs/architecture/finance.md
- `TripExpenseSheet()` --implements--> `Trip expense sheet`  [INFERRED]
  src/components/finance/trip-expense-sheet.tsx → docs/architecture/finance.md
...
## Communities (753 total, 210 thin omitted)

### Community -1 - "Finance"
Cohesion: 0.03
Nodes (73): /finance, /finance/categories, /finance/expected, /finance/movements, agreed, Amount-free payroll reminders, category_id, Category snapshots (+65 more)

### Community 0 - "button.tsx"
Cohesion: 0.05
Nodes (68): react, react, saveFinancePlanning(), Editor, FinanceCategoriesWorkspace(), ManagedCategory, FinanceCategoryEditor(), FinanceCategorySelect() (+60 more)
...
### Community 2 - "overview-summaries.integration.test.ts"
Cohesion: 0.12
Nodes (21): OfficeOverviewPage(), AssignmentRow(), Activity, AssignmentSummaryRow, getOfficeOverview(), person(), SubmissionSummaryRow, accounts (+13 more)

### Community 3 - "leads-workspace.tsx"
Cohesion: 0.08
Nodes (35): Action, CrmActionForm(), CandidateSourceField(), NotesField(), formatDate(), getCurrencySymbol(), LeadDetail(), LeadFormFields() (+27 more)

### Community 4 - "lib/finance.ts"
Cohesion: 0.07
Nodes (35): saveFinanceFoundation(), mocks, valuation, saveFinanceMovement(), input, mocks, COMMON_FINANCE_CURRENCY_CODES, FinanceCurrencySelect() (+27 more)
...
### Community 6 - "queries/index.ts"
Cohesion: 0.06
Nodes (44): dashboardMetrics, employeeWorkload, getAccessibleProjects(), getDashboardMetrics(), getEmployeeWorkload(), getMyTasks(), getProjectAreaProgress(), getProjectById() (+36 more)

### Community 7 - "context.mjs"
Cohesion: 0.05
Nodes (92): appendAutonomyCounterDirective(), appendDetectorFallback(), appendImageGenDirective(), appendImageToolsDirective(), appendStalenessDirective(), appendSubagentAuthorizationDirective(), appendSurfaceBriefContext(), automaticHookMode() (+84 more)
...
Cohesion: 0.04
Nodes (85): POST(), PATCH(), PATCH(), PATCH(), DELETE(), PATCH(), POST(), PATCH() (+77 more)

### Community 10 - "svelte-component.mjs"
Cohesion: 0.08
...
### Community 11 - "trip-entry-editor.tsx"
Cohesion: 0.10
Nodes (37): saveFinanceTrip(), input, mocks, ProjectTripsSection(), Entry, Foundation, isEditorInteraction(), isEditorTarget() (+29 more)

### Community 12 - "lib/calendar.ts"
Cohesion: 0.06
...
### Community 13 - "injected/index.mjs"
Cohesion: 0.06
...
### Community 14 - "profile-editor-dialog.tsx"
Cohesion: 0.10
Nodes (27): AvatarCropStep(), ImageDimensions, loadImageDimensions(), readFileAsDataUrl(), ConnectionStatus, GoogleCalendarIntegration(), isConnectionStatus(), toConnectionStatus() (+19 more)
...
### Community 17 - "getActiveStudioMembership"
Cohesion: 0.08
Nodes (33): Context, DELETE(), isDateOnly(), isRecord(), parseDayOff(), PATCH(), requireAdmin(), isDateOnly() (+25 more)
...
Cohesion: 0.07
Nodes (64): extensions, formatReport(), fs, getFiles(), main(), parseArgs(), path, patterns (+56 more)

### Community 20 - "design-system.mjs"
Cohesion: 0.07
...
### Community 21 - "project-task-board.tsx"
Cohesion: 0.04
Nodes (92): LeadStatusPill(), ProjectSignals(), MyTasksList(), sections, BoardColumn(), BulkAssignmentScope, BulkColumnDragHandle(), BulkDragSource (+84 more)

### Community 22 - "detect-text.mjs"
Cohesion: 0.10
...
### Community 23 - "project-form.tsx"
Cohesion: 0.07
Nodes (44): ProjectTemplatesPage(), ProjectContextActions(), Field(), ProjectForm(), TemplateSummary(), ProjectCountrySelect(), ProjectMetadataDefaults, ProjectTypeSelect() (+36 more)

### Community 24 - "dialog.tsx"
Cohesion: 0.05
Nodes (51): restoreStudioMember(), LoginPage(), ChecklistTemplateManager(), createStage(), Draft, SortableStageRow(), stageKeyboardSensor, stagePointerSensor (+43 more)

### Community 25 - "types/calendar.ts"
Cohesion: 0.05
Nodes (47): calendarQuery, route, Context, PATCH(), CalendarSupabaseClient, getVerifiedTimeOffMembership(), POST(), VerifiedTimeOffMembership (+39 more)

### Community 26 - "doctor.mjs"
Cohesion: 0.09
Nodes (53): applyFixes(), cli(), collect(), parseArgs(), readProjectRootPatterns(), rel(), renderText(), safeRead() (+45 more)

### Community 27 - "accept-css.mjs"
Cohesion: 0.20
...
### Community 28 - "project-list.tsx"
Cohesion: 0.07
Nodes (43): ProjectListControls(), resetProjectListFilters(), contextBandPath, controlsPath, listPath, projectPagePath, healthKeys, PrioritySignal() (+35 more)

### Community 29 - "setLiveState"
Cohesion: 0.08
...
### Community 30 - "/finance/schedules"
Cohesion: 0.29
Nodes (5): /finance/schedules, Recurring payment groups, Team payroll setup, public.finance_recurring_groups, public.finance_schedules

### Community 31 - "hook-lib.mjs"
Cohesion: 0.06
Nodes (63): ADVISORY_RULES, applyConfigSource(), applyDetectorConfigSource(), applyPatchText(), canonicalPathCache, clampByte(), clampGroupedToBudget(), clampToBudget() (+55 more)

### Community 32 - "calendar-workspace.tsx"
Cohesion: 0.06
Nodes (38): CalendarPage(), validDate(), CalendarChipIcon(), CalendarDetailHeaderIcon(), CalendarEventDetails(), CalendarPill(), CalendarWorkspace(), dateLabel() (+30 more)

### Community 33 - "lib/project-progress.ts"
Cohesion: 0.05
Nodes (86): FocusLine(), formatStatusAge(), InlineTask(), METRICS, metricValue(), statusKey(), TeamWorkload(), DashboardTaskList() (+78 more)
...
### Community 35 - "team/page.tsx"
Cohesion: 0.10
Nodes (32): GET(), TeamPage(), DirectoryRow, getCurrentStudioTeam(), ProfileRow, StudioMemberRow, TeamMember, isAppLocale() (+24 more)

### Community 36 - "project.ts"
Cohesion: 0.09
Nodes (39): Project financial summary and payment presentation, FinancePage(), FinanceExpectedPage(), FinancePage(), FinanceCashPlanningPage(), FinanceSchedulesPage(), TripsPage(), TripPage() (+31 more)

### Community 37 - "concept-seed.mjs"
Cohesion: 0.08
Nodes (48): API_BASE, API_TIMEOUT_MS, apiBudgetMs(), dealCompositions(), driveSelection(), fetchRoll(), here, loadLocal() (+40 more)

### Community 38 - "domain-messages.tsx"
Cohesion: 0.05
Nodes (20): CrmLayout(), FinanceLayout(), geistMono, geistSans, RootLayout(), viewport, CrmShell(), FinanceNavigation() (+12 more)
...
Cohesion: 0.09
Nodes (33): inviteEmployee(), isExistingAuthUserError(), removeStudioMember(), updateStudioMemberProfile(), InviteEmployeeForm(), StudioMemberProfileEditor(), EmployeeInvitationActionState, EmployeeInvitationField (+25 more)

### Community 42 - "detect-html.mjs"
Cohesion: 0.06
Nodes (47): mergeDesignSystemFindings(), runTextContentAnalyzers(), applyStaticDeclaration(), buildBorderOverrideMap(), buildStaticStyleMap(), buildStaticWindow(), collectStaticCssRules(), collectStaticCssText() (+39 more)

### Community 43 - "impeccable-config.mjs"
Cohesion: 0.10
Nodes (47): applyDetectionConfigSource(), clampByte(), cleanIgnoreValueDisplay(), cloneDetectionConfig(), cloneRawDetectionConfig(), colorIgnoreKey(), DEFAULT_DETECTION_CONFIG, DETECTOR_CONFIG_KEYS (+39 more)

### Community 44 - "contractor-directory.tsx"
Cohesion: 0.12
Nodes (28): ClassificationOption, ContractorCategoryCombobox(), ContractorSubcategoryCombobox(), CreatableClassificationCombobox(), getUniqueContractorCategories(), getUniqueContractorSubcategories(), uniqueOptions(), ContractorAction (+20 more)

### Community 45 - "project-value-builder.tsx"
Cohesion: 0.11
Nodes (31): Project value and payment schedule builder, getProjectReferenceRate(), saveFinanceProject(), mocks, ExpectedForm(), decimalText(), PaymentRow(), paymentSensors (+23 more)

### Community 46 - "notification-presentation.ts"
Cohesion: 0.18
...
Cohesion: 0.20
Nodes (23): finance_allocations, finance_currencies, finance_expected_items, finance_movement_entries, finance_movements, finance_settings, finance_trip_balances, finance_trip_entries (+15 more)

### Community 50 - "cash-planning-workspace.tsx"
Cohesion: 0.09
Nodes (36): FinanceCashChart(), FinanceCashPlanningWorkspace(), Props, FinanceExpectedWorkspace(), FinanceOverviewWorkspace(), PlanningForecast(), PageHeader(), FinanceForecastData (+28 more)

### Community 51 - "checkHtmlPatterns"
Cohesion: 0.13
Nodes (28): ANIMATION_VALUE_KEYWORDS, buildHtmlPatternCorpora(), checkGlow(), checkHtmlPatterns(), collectCssCustomProps(), collectMarqueeKeyframes(), collectPulseKeyframes(), cssLengthToPx() (+20 more)
...
Cohesion: 0.13
Nodes (32): checkCreamPalette(), checkElementAIPaletteDOM(), checkElementColors(), checkElementColorsDOM(), checkElementGlowDOM(), checkElementHoverContrast(), checkElementIconTile(), checkElementIconTileDOM() (+24 more)

### Community 55 - "time-off-compensation.ts"
Cohesion: 0.31
...
### Community 59 - "google-calendar/sync.ts"
Cohesion: 0.13
Nodes (29): isCalendarEventRelevantToUser(), atGoogleCalendarStage(), isReconnectRequiredError(), addCounts(), CalendarEventRow, CalendarInviteRow, CalendarParticipantRow, getGoogleClient() (+21 more)

### Community 60 - "design-parser.mjs"
Cohesion: 0.13
...
### Community 63 - "hook-before-edit.mjs"
Cohesion: 0.10
Nodes (41): allow(), bumpCursorDenial(), cursorBlockMessage(), deny(), detectProposedHtml(), done(), escapeRegExp(), findingSignature() (+33 more)

### Community 64 - "page"
Cohesion: 0.06
Nodes (33): page, admin, captureContainedTransition(), choose(), localSql(), login(), open(), panel() (+25 more)

### Community 65 - "Brand Guidelines v1.0"
Cohesion: 0.05
...
### Community 68 - "live-inject.mjs"
Cohesion: 0.23
Nodes (14): describeInjectArtifacts(), frameworkIgnorePatterns(), resolveFramework(), __dirname, ensureLiveGitIgnores(), escapeRegExp(), globToRegex(), HARD_EXCLUDES (+6 more)

### Community 69 - "bootstrap-studio.ts"
Cohesion: 0.09
...
### Community 71 - "equipment-catalog/sync.ts"
Cohesion: 0.12
Nodes (29): localFile(), main(), GET(), mocks, catalogError(), formatCatalogError(), CatalogImportRow, componentFamilyPattern() (+21 more)

### Community 72 - "lib/administration.ts"
Cohesion: 0.12
Nodes (30): AdminPage(), AdministrationWorkspace(), AvailabilityRow(), DecisionRow(), PendingRequestRow(), RequestDrawer(), typeKey(), getAdministrationData() (+22 more)

### Community 73 - "instantToDateOnly"
Cohesion: 0.12
Nodes (29): Context, DELETE(), PATCH(), POST(), PATCH(), responseSchema, getNormalizedCalendarEvent(), CalendarCreatorRole (+21 more)

### Community 74 - "equipment-workspace.tsx"
Cohesion: 0.07
Nodes (47): configurationLabels(), CreateEquipmentDialog(), CreateKind, CreateWorkstationDialog(), EquipmentAttachPicker(), EquipmentDrawer(), EquipmentGroup(), equipmentIcons (+39 more)
...
### Community 76 - "submissions/actions.ts"
Cohesion: 0.11
Nodes (21): addSubmissionComment(), createSubmission(), InsertedCommentRow, loadSubmissionDetail(), refresh(), toggleSuggestionSupport(), CreateSubmissionDialog(), accounts (+13 more)

### Community 77 - "floor-plan-view.tsx"
Cohesion: 0.12
Nodes (31): DragState, EntityList(), fitViewBox(), FloorPlanEntity, floorPlans, FloorPlanView(), Legend(), PanState (+23 more)

### Community 78 - "types/tasks.ts"
Cohesion: 0.07
Nodes (37): MyTasksPage(), ChecklistItemEditorRow(), oldDashboardTasks(), attachDeadlineCompletions(), DeadlineCompletionRow, getMyTasks(), getTaskCurrentStatusEnteredAt(), getTaskStatusHistory() (+29 more)

### Community 79 - "spacing"
Cohesion: 0.06
Nodes (34): $type, $value, $type, $value, $type, $value, $type, $value (+26 more)

### Community 80 - "impeccable/SKILL.md"
Cohesion: 0.07
...
### Community 81 - "lib/project-lifecycle.ts"
Cohesion: 0.15
Nodes (23): PATCH(), ProjectLifecycleMutationResult, updateProjectLifecycleStatus(), canUpdateProjectMetadata(), canWorkOnTaskInProject(), countOpenLifecycleTasks(), getAutomaticProjectStatus(), getLifecycleCompletedAt() (+15 more)

### Community 82 - "Management Overview"
Cohesion: 0.14
Nodes (22): Finance Overview projection, RLS and explicit grants, Accessible exact chart data, Actual flow comparison, Daily forecast chart, Decimal money rendering, Exact monetary arithmetic, finance_cash_effects (+14 more)

### Community 83 - "queries/calendar.ts"
Cohesion: 0.09
Nodes (26): CalendarQueryInput, getCalendarData(), mocks, getCalendarTasks(), accounts, cases, clients, enabled (+18 more)

### Community 84 - "database.types.ts"
Cohesion: 0.06
Nodes (30): mocks, mocks, overview, report, updateSession(), config, proxy(), ApplicationDatabase (+22 more)
...
### Community 87 - "live-copy-edit-agent.mjs"
Cohesion: 0.14
...
### Community 90 - "add-task-dialog.tsx"
Cohesion: 0.09
Nodes (25): AppHeader(), AssignmentAdminControls(), CreateAssignmentDialog(), AddProjectMemberForm(), ProjectTeamSection(), AdminControls(), AddTaskDialog, AddTaskDialogHandle (+17 more)

### Community 91 - "cn"
Cohesion: 0.10
Nodes (25): SpaceLogoFull(), StudioFlowMark(), AppSidebar(), MobileNavigation(), OfficeShell(), tabs, CityCombobox(), isCityResult() (+17 more)
...
### Community 93 - "Component Specifications"
Cohesion: 0.07
...
### Community 95 - "admin-dashboard.tsx"
Cohesion: 0.07
Nodes (34): ArchivePage(), DashboardPage(), Deadlines(), Employee(), mocks, AdminDashboardView(), AttentionItem, Availability() (+26 more)

### Community 96 - "html-token-validator.py"
Cohesion: 0.14
Nodes (24): get_context(), is_allowed_exception(), is_allowed_rgba(), is_inside_block(), load_css_variables(), main(), print_result(), print_summary() (+16 more)

### Community 97 - "roots.mjs"
Cohesion: 0.16
...
Cohesion: 0.17
Nodes (18): PATCH(), PATCH(), logStageColumnsSaveError(), updateProjectStageConfiguration(), updateProjectStageSettings(), getProjectStageColumns(), getProjectStageConfiguration(), ProjectStageConfiguration (+10 more)

### Community 99 - "set-password-form.tsx"
Cohesion: 0.18
Nodes (13): GET(), getInvalidLinkRedirect(), setUserPassword(), SetPasswordPage(), SetPasswordForm(), getSafeConfirmationDestination(), getSupportedEmailOtpType(), SupportedEmailOtpType (+5 more)

### Community 100 - "20260719221450_initial_schema.sql"
Cohesion: 0.13
...
### Community 102 - "live-manual-edit-evidence.mjs"
Cohesion: 0.16
Nodes (26): analyzeSourceHint(), buildCandidatesForOp(), buildContextHintsByRef(), buildManualEditEvidence(), collectSearchFiles(), countOps(), decodeBasicHtml(), escapeRegExp() (+18 more)

### Community 103 - "submissions-workspace.tsx"
Cohesion: 0.09
Nodes (19): manageSubmission(), officeWorkflowStyles, OfficeWorkflowTone, OfficeCreateKind, useOfficeOverlayRouting(), DetailLoader, InboxFilter, initialCreateState (+11 more)

### Community 104 - "Asset Approval Checklist"
Cohesion: 0.08
...
### Community 105 - "Responsive Design"
Cohesion: 0.08
Nodes (25): Assess Adaptation Challenge, Breakpoints: Content-Driven, Content Adaptation, Desktop Adaptation (Mobile → Desktop), Detect Input Method, Not Just Screen Size, Email Adaptation (Web → Email), Implement Adaptations, Layout Adaptation Patterns (+17 more)

### Community 106 - "createClient"
Cohesion: 0.08
Nodes (64): deleteContractor(), deleteContractorCategory(), renameContractorCategory(), updateContractorCategoryColor(), FinanceCategoriesPage(), removeFinanceCategory(), FinanceMovementsPage(), saveFinanceCashPlan() (+56 more)

### Community 107 - "handleManualEditActivity"
Cohesion: 0.17
...
### Community 108 - "event-validation.mjs"
Cohesion: 0.14
Nodes (25): AGENT_PHASE_SET, FORBIDDEN_MANUAL_EDIT_TEXT_CHARS, INSERT_POSITIONS, isValidId(), isValidMountVariant(), isValidVariantId(), validateAnnotationFields(), validateEvent() (+17 more)

### Community 109 - "lib/submissions.ts"
Cohesion: 0.17
Nodes (18): SubmissionRow(), SubmissionWorkflowAction(), canRejectSubmission(), getAllowedNextStatuses(), getPrimarySubmissionAction(), getPrimarySubmissionStatus(), isSubmissionStatus(), isSubmissionType() (+10 more)

### Community 110 - "[projectId]/page.tsx"
Cohesion: 0.08
Nodes (33): PATCH(), mocks, getProjectView(), getProjectViewHref(), ProjectDetails(), ProjectDetailsPage(), ProjectPageSearchParams, ProjectView (+25 more)

### Community 111 - "validation/equipment.ts"
Cohesion: 0.11
Nodes (23): completeEquipmentServiceSchema, EquipmentActionState, equipmentAssignmentSchema, equipmentDeleteSchema, equipmentFieldUpdateSchema, EquipmentInput, equipmentInputSchema, equipmentMaintenanceSchema (+15 more)

### Community 112 - "Color Palette Management"
Cohesion: 0.08
...
### Community 113 - "States and Variants"
Cohesion: 0.08
...
### Community 114 - "tag-strategy.mjs"
Cohesion: 0.26
...
### Community 120 - "queries/equipment.ts"
Cohesion: 0.13
Nodes (16): EquipmentPage(), EquipmentWorkspace(), useEquipmentRouting(), ActiveStudioMembership, EquipmentMember, EquipmentRow, EquipmentServiceEvent, EquipmentServiceEventRow (+8 more)

### Community 121 - "Design System"
Cohesion: 0.09
...
### Community 122 - "onboard.md"
Cohesion: 0.09
Nodes (22): Assess Onboarding Needs, Context Over Ceremony, Contextual Help, Design Onboarding Experiences, Documentation & Help, Empty State Design, Feature Discovery & Adoption, Guided Tours & Walkthroughs (+14 more)

### Community 123 - "checkQuality"
Cohesion: 0.15
...
### Community 124 - "manual-edit-routes.mjs"
Cohesion: 0.19
...
### Community 127 - "project-activity-section.tsx"
Cohesion: 0.20
...
### Community 128 - "equipment-form.tsx"
Cohesion: 0.10
Nodes (25): AccordionSection(), EquipmentFormFields(), Section, EquipmentItem, WorkstationItem, isEquipmentType(), capacity, CAPACITY_UNITS (+17 more)

### Community 129 - "candidates-workspace.tsx"
Cohesion: 0.06
Nodes (42): loadCandidateCycles(), CrmCandidatesPage(), CrmLeadsPage(), CandidateCycleFields(), CandidateDetail(), CandidatesWorkspace(), CycleLoader, formatDate() (+34 more)

### Community 130 - "GSAP Core"
Cohesion: 0.10
...
Cohesion: 0.39
Nodes (5): AccessUnavailablePage(), AppLayout(), generateMetadata(), resolveActiveStudioMembership, getCrmOverdueLeadFollowUpCount()

### Community 135 - "private.sync_calendar_finance_trip"
Cohesion: 0.15
Nodes (15): public.profiles, public.studio_members, public.create_project_from_template(), public.crm_lead_history, public.crm_leads, public.projects, public.profiles, private.sync_calendar_finance_trip() (+7 more)

### Community 136 - "generate-slide.py"
Cohesion: 0.15
Nodes (19): _e(), generate_chart_slide(), generate_cta_slide(), generate_deck(), generate_metrics_slide(), generate_problem_slide(), generate_solution_slide(), generate_testimonial_slide() (+11 more)

### Community 137 - "analyzeVisualContrastCandidate"
Cohesion: 0.14
...
### Community 140 - "DesignSystemGenerator"
Cohesion: 0.14
...
### Community 141 - "20260917141123_finance_compensation_recurring.sql"
Cohesion: 0.17
...
### Community 142 - "20260922091623_finance_business_trips.sql"
Cohesion: 0.22
Nodes (16): finance_trip_allocation, finance_trip_balances_immutable, finance_trip_entries_immutable, finance_trip_expected_guard, finance_z_trip_cash, private.guard_finance_trip_expected(), private.reconcile_finance_trip(), private.reconcile_finance_trip_settlement() (+8 more)
...
### Community 147 - "app-header.tsx"
Cohesion: 0.13
Nodes (19): LanguageSelector(), ProfileAvatarEditor(), ProfileAvatarEditorProps, ProfileEditorDialog, ShellControl, ShellControlProps, applyTheme(), getServerThemeSnapshot() (+11 more)

### Community 148 - "schedules/actions.ts"
Cohesion: 0.19
Nodes (15): saveFinanceGroup(), saveFinanceSchedule(), saveInitialPayroll(), mocks, planningAmount, employeeBonusSchema, financeScheduleError(), financeScheduleValidationError() (+7 more)

### Community 149 - "live-status.mjs"
Cohesion: 0.23
Nodes (17): getLegacyLiveSessionsDir(), getLiveSessionsDir(), readLiveServerInfo(), collectManualApplyFiles(), manualApplyReplyCommand(), manualApplyResumeHint(), mountFailureAction(), parseArgs() (+9 more)
...
### Community 152 - "fetch-background.py"
Cohesion: 0.17
Nodes (17): generate_css_for_background(), get_background_image(), get_curated_images(), get_overlay_css(), get_pexels_search_url(), load_backgrounds_config(), load_brand_colors(), main() (+9 more)

### Community 153 - "sveltekit-adapter.mjs"
Cohesion: 0.24
...
### Community 157 - "session-store.mjs"
Cohesion: 0.18
...
### Community 158 - "20260917182151_finance_automatic_schedule_occurrences.sql"
Cohesion: 0.14
...
### Community 159 - "tanstack-adapter.mjs"
Cohesion: 0.20
...
### Community 161 - "design_system.py"
Cohesion: 0.15
...
### Community 162 - "fontSize"
Cohesion: 0.11
Nodes (20): $type, $value, $type, $value, $type, $value, $type, $value (+12 more)

### Community 163 - "animate.md"
Cohesion: 0.12
Nodes (14): Accessibility and control, Choose material by meaning, Find the job, Implement to the runtime, Set the motion thesis, Timing and easing, Verify, Visitor mode (+6 more)

### Community 164 - "Handle `generate`"
Cohesion: 0.12
Nodes (16): 1. Read the screenshot (if present), 2. Wrap the element, 3. Load the action's reference, 4. Plan three variants: identity first, then mode, then axes, 5. Apply the freeform prompt (if present), 6. Deliver variants, 7. Parameters (composition-sized, 0-4 per variant), 8. Signal done (+8 more)

### Community 165 - "scanCssTextForPulsingDot"
Cohesion: 0.09
Nodes (40): buildHtmlPatternCorpora(), checkColors(), checkElementGlow(), checkGlow(), checkHoverContrast(), checkHtmlPatterns(), checkRadialSpotlight(), collectCssCustomProps() (+32 more)

### Community 166 - "serve-question.mjs"
Cohesion: 0.13
...
### Community 168 - "Writing Guidelines for Postgres References"
Cohesion: 0.12
Nodes (15): 1. Concrete Transformation Patterns, 2. Error-First Structure, 3. Quantified Impact, 4. Self-Contained Examples, 5. Semantic Naming, Code Example Standards, Comments, Impact Level Guidelines (+7 more)

### Community 169 - "20260904120000_internal_submissions.sql"
Cohesion: 0.17
...
### Community 174 - "resolveLiveInjectionAnchor"
Cohesion: 0.16
...
### Community 176 - "detect-utils.mjs"
Cohesion: 0.28
...
### Community 177 - "Copywriting Formulas"
Cohesion: 0.13
...
### Community 179 - "calendar-event-types.ts"
Cohesion: 0.21
...
### Community 180 - "20260916233308_finance_expected_settlement.sql"
Cohesion: 0.19
...
### Community 181 - "20260917114733_finance_project_agreements.sql"
Cohesion: 0.26
...
### Community 182 - "public.record_finance_trip_entry"
Cohesion: 0.23
Nodes (11): Atomic append-only trip entry edits, edit_finance_trip_entry, Original actual retains plan baseline, public.record_finance_movement(), public.reverse_finance_movement(), private.begin_finance_planning(), public.release_finance_allocation(), public.save_finance_expected_item() (+3 more)

### Community 183 - "finance-planning.ts"
Cohesion: 0.18
Nodes (12): mocks, EntryForm(), FinanceMovementsWorkspace(), allocationInputSchema, categoryInputSchema, expectedInputSchema, FinanceCategory, financeMovementCategoryLabel() (+4 more)

### Community 184 - "productivity.ts"
Cohesion: 0.10
Nodes (34): BonusBadge(), formatArea(), LeaderboardPage(), getCurrentUserProfile, getLeaderboardForPeriod(), getLeaderboardOverviewData(), canAccessLeaderboard(), LeaderboardAccessContext (+26 more)

### Community 185 - "Messaging Framework"
Cohesion: 0.14
...
### Community 186 - "finance_expected_items"
Cohesion: 0.13
Nodes (30): Actual refunds, cancel_finance_project_expectation, complete_finance_payroll_cost, Established outstanding, Expected settlement, finance_allocations, finance_expected_balances, finance_expected_items (+22 more)

### Community 187 - "Brand Voice Framework"
Cohesion: 0.14
...
### Community 188 - "extract-colors.cjs"
Cohesion: 0.22
Nodes (11): calculateCompliance(), colorDistance(), displayPalette(), extractHexColors(), findNearestBrandColor(), fs, generateImageMagickCommand(), hexToRgb() (+3 more)

### Community 189 - "validate-asset.cjs"
Cohesion: 0.25
Nodes (13): checkManifest(), formatBytes(), formatOutput(), fs, main(), parseFilename(), path, RULES (+5 more)

### Community 190 - "Tailwind Integration"
Cohesion: 0.14
...
### Community 191 - "radius"
Cohesion: 0.11
Nodes (27): $type, $value, lg, sm, $type, $value, $type, $value (+19 more)

### Community 192 - "Impeccable Asset Producer"
Cohesion: 0.14
...
### Community 196 - "frameworks/index.mjs"
Cohesion: 0.12
Nodes (16): COMMENT_SYNTAXES, FRAMEWORKS, INJECT_KINDS, PATCH_UNDOERS, PREVIEW_MODES, SOURCE_TRAIT_DEFAULTS, STYLE_MODES, applyNuxtLiveAdapter() (+8 more)

### Community 197 - "Layout Patterns"
Cohesion: 0.14
Nodes (13): Card Styles, Component Variants, CSS Structures, Feature Grid (3 columns), Layout Decision Flow, Layout Patterns, Layout Selection by Use Case, Metric Styles (+5 more)

### Community 198 - "assignments/actions.ts"
Cohesion: 0.22
Nodes (12): manageOfficeAssignment(), refreshOffice(), transitionOfficeAssignment(), AssignmentDetailDrawer(), statusStyle(), OFFICE_ASSIGNMENT_PRIORITIES, OFFICE_ASSIGNMENT_STATUSES, createOfficeAssignmentSchema (+4 more)

### Community 199 - "equipment-catalog.ts"
Cohesion: 0.29
...
### Community 200 - "forgot-password/actions.ts"
Cohesion: 0.27
...
### Community 201 - "20260730120100_task_progress_checklists.sql"
Cohesion: 0.23
...
### Community 202 - "20260916200241_finance_foundation.sql"
Cohesion: 0.18
Nodes (10): guard_finance_settings, private.guard_finance_account(), private.guard_finance_settings(), private.is_finance_admin(), public.finance_accounts, public.finance_currencies, public.finance_settings, set_finance_accounts_updated_at (+2 more)

### Community 203 - "finance-project-hardening.spec.ts"
Cohesion: 0.15
Nodes (10): actors, bankId, categoryId, clearFoundation(), client, contractorId, local, projectId (+2 more)

### Community 204 - "brand/references/update.md"
Cohesion: 0.15
...
### Community 205 - "Token Architecture"
Cohesion: 0.15
...
### Community 206 - "design-tokens-starter.json"
Cohesion: 0.15
Nodes (12): component, $type, $value, dark, semantic, $schema, $type, $value (+4 more)

### Community 207 - "crm/actions.ts"
Cohesion: 0.19
Nodes (21): context(), createCandidate(), deleteCandidate(), deleteLead(), failure(), loadLeadHistory(), nullable(), recruitingCycleParameters() (+13 more)

### Community 208 - "GSAP with React"
Cohesion: 0.15
...
### Community 209 - "Scan mode (approach C: auto-extract, then confirm descriptive language)"
Cohesion: 0.15
...
### Community 212 - "google-calendar/diagnostics.ts"
Cohesion: 0.18
Nodes (17): GET(), hasValidCronAuthorization(), asGoogleCalendarSyncError(), DiagnosticContext, extractFailureFields(), GoogleCalendarFailureDiagnostic, googleCalendarJobLastError(), GoogleCalendarSyncError (+9 more)

### Community 213 - "20260813143000_per_task_studio_member_removal.sql"
Cohesion: 0.24
...
### Community 215 - "board-collapse.spec.ts"
Cohesion: 0.14
Nodes (11): accounts, card(), column(), login(), projectId, service, settings, smallProjectId (+3 more)

### Community 216 - "dashboard-operational.spec.ts"
Cohesion: 0.15
Nodes (10): admins, approvedAbsence, employee, emptyStudio, login(), pendingAbsence, populatedStudio, project (+2 more)

### Community 217 - "task-payload.spec.ts"
Cohesion: 0.15
Nodes (10): accounts, legacyWorkId, login(), projectId, recentFocusId, reviewTaskId, service, settings (+2 more)

### Community 218 - "Primitive Tokens"
Cohesion: 0.17
...
Cohesion: 0.15
Nodes (23): Finance cash planning persistence, /finance/planning, Cash Budget, Cash projection, Category Budget Forecast Actual, Current-FX trip plan estimates, finance_account_balances, finance_budget_revisions (+15 more)

### Community 221 - "GSAP Performance"
Cohesion: 0.17
...
### Community 223 - "Simplify the Design"
Cohesion: 0.17
...
### Community 224 - "Hardening Dimensions"
Cohesion: 0.17
Nodes (11): Accessibility Resilience, Assess Hardening Needs, Edge Cases & Boundary Conditions, Error Handling, Hardening Dimensions, Input Validation & Sanitization, Internationalization (i18n), Performance Resilience (+3 more)

### Community 225 - "ui-core.mjs"
Cohesion: 0.23
...
### Community 227 - "generation-preflight.mjs"
Cohesion: 0.30
...
### Community 228 - "google-calendar-automatic-sync.test.ts"
Cohesion: 0.20
Nodes (8): createRoute, cronRoute, eventRoute, grantMigration, invitationRoute, migration, queue, sync

### Community 229 - "20260728153858_calendar_foundation.sql"
Cohesion: 0.24
...
### Community 231 - "20260910221602_equipment_maintenance.sql"
Cohesion: 0.24
...
### Community 232 - "20260920131009_finance_payroll_hardening.sql"
Cohesion: 0.24
...
### Community 240 - "Nielsen's 10 Heuristics"
Cohesion: 0.18
Nodes (11): 10. Help and Documentation, 1. Visibility of System Status, 2. Match Between System and Real World, 3. User Control and Freedom, 4. Consistency and Standards, 5. Error Prevention, 6. Recognition Rather Than Recall, 7. Flexibility and Efficiency of Use (+3 more)

### Community 241 - "Generate Combined Critique Report"
Cohesion: 0.18
...
### Community 244 - "quieter.md"
Cohesion: 0.18
Nodes (10): Assess Current State, Color Refinement, Composition Refinement, Motion Reduction, Plan Refinement, Refine the Design, Simplification, Verify Quality (+2 more)

### Community 245 - "detect-csp.mjs"
Cohesion: 0.35
Nodes (10): detectCsp(), INLINE_HEADER_SIGNALS, LAYOUT_EXTS, MONOREPO_HELPER_SIGNALS, NUXT_ROUTE_RULES_SIGNALS, NUXT_SECURITY_SIGNALS, SCAN_EXTS, SKIP_DIRS (+2 more)

### Community 246 - "checkTextOcclusionDOM"
Cohesion: 0.22
...
### Community 250 - "Tasks"
Cohesion: 0.18
Nodes (11): Authorization and mutation invariants, Board interaction, Boundary, Canonical sources, Checklists, Milestone deadlines, Progress, Stages and workflow (+3 more)

### Community 251 - "lib/crm.ts"
Cohesion: 0.15
Nodes (17): getLeadProjectDefaults(), isNestedInteractiveTarget(), LeadFollowUpDialog(), LeadFollowUpFields(), LeadsWorkspace(), CandidateFilterRecord, CandidateStatusFilter, CrmFollowUpQuickChoice (+9 more)

### Community 252 - "project-form.contract.test.ts"
Cohesion: 0.18
...
### Community 253 - "google-calendar-integration.test.ts"
Cohesion: 0.18
Nodes (9): callbackRoute, connectRoute, disconnectRoute, en, integrationUi, migration, sync, tokenCrypto (+1 more)

### Community 254 - "20260819110000_calendar_event_invitations.sql"
Cohesion: 0.31
...
### Community 255 - "20260904135441_office_assignments.sql"
Cohesion: 0.24
...
### Community 258 - "finance-project-builder.spec.ts"
Cohesion: 0.20
Nodes (10): actors, bankId, categoryId, clearFoundation(), client, contractorId, local, projectId (+2 more)

### Community 259 - "finance-project-visual.spec.ts"
Cohesion: 0.20
Nodes (10): actors, bankId, categoryId, clearFoundation(), client, contractorId, local, projectId (+2 more)
...
### Community 261 - "Component Tokens"
Cohesion: 0.20
...
### Community 262 - "generate-tokens.cjs"
Cohesion: 0.36
...
### Community 264 - "CORE DIRECTIVE: AWWWARDS-LEVEL DESIGN ENGINEERING"
Cohesion: 0.20
...
### Community 267 - "Slide Strategies"
Cohesion: 0.20
...
### Community 268 - "Section Definitions"
Cohesion: 0.20
...
### Community 273 - "20260818170000_project_stage_columns_and_internal_review.sql"
Cohesion: 0.22
...
### Community 274 - "20260827120000_task_collaborators.sql"
Cohesion: 0.27
...
### Community 275 - "20260908144506_create_crm_foundation.sql"
Cohesion: 0.27
...
### Community 276 - "20260920121044_finance_opening_valuation.sql"
Cohesion: 0.27
...
### Community 278 - "finance-foundation.spec.ts"
Cohesion: 0.24
Nodes (8): actors, clearFoundation(), client, local, record(), select(), sql(), studioId

### Community 279 - "finance-overview.spec.ts"
Cohesion: 0.20
Nodes (8): actors, bank, client, foreign, local, login(), secondBank, studio

### Community 280 - "finance-visual-audit.spec.ts"
Cohesion: 0.20
Nodes (8): actors, bank, client, foreign, local, login(), secondBank, studio

### Community 281 - "sync-brand-to-tokens.cjs"
Cohesion: 0.33
...
### Community 283 - "Common Cognitive Load Violations"
Cohesion: 0.22
...
### Community 290 - "20260829170000_add_business_trip_participants.sql"
Cohesion: 0.28
...
### Community 291 - "20260910193120_equipment_domain_foundation.sql"
Cohesion: 0.31
...
### Community 292 - "20260916221929_finance_actual_movements.sql"
Cohesion: 0.44
...
### Community 293 - "20260917170558_finance_budget_forecast.sql"
Cohesion: 0.22
...
### Community 294 - "20260920170000_finance_serialized_capture.sql"
Cohesion: 0.31
...
### Community 298 - "contractors/actions.ts"
Cohesion: 0.24
Nodes (15): createContractor(), getContractorValues(), nullable(), parseForm(), resolveContractorClassification(), updateContractor(), ContractorFormActionState, ContractorFormField (+7 more)

### Community 299 - "segmented-control.tsx"
Cohesion: 0.23
Nodes (8): LeaderboardPeriodSwitcher(), Member, TeamDirectory(), getSegmentedControlItemProps(), SegmentedControl(), SegmentedControlItem, source, LeaderboardPeriod

### Community 300 - "StudioFlow"
Cohesion: 0.18
Nodes (11): Context routing, Database workflow, Documentation maintenance, Execution priority, External research, Graphify, Skill routing, Source of truth (+3 more)

### Community 301 - "input"
Cohesion: 0.15
Nodes (17): $type, $value, padding-x, padding-y, border, border, input, $type (+9 more)

### Community 302 - "Persona-Based Design Testing"
Cohesion: 0.25
Nodes (8): 1. Impatient Power User: "Alex", 2. Confused First-Timer: "Jordan", 3. Accessibility-Dependent User: "Sam", 4. Deliberate Stress Tester: "Riley", 5. Distracted Mobile User: "Casey", Persona-Based Design Testing, Project-Specific Personas, Selecting Personas

### Community 303 - "doctor.md"
Cohesion: 0.25
...
### Community 304 - "Extract Flow"
Cohesion: 0.25
Nodes (7): Extract Flow, Step 1: Discover the Design System, Step 2: Identify Patterns, Step 3: Plan Extraction, Step 4: Extract & Enrich, Step 5: Migrate, Step 6: Document

### Community 305 - "checkElementRadialSpotlightDOM"
Cohesion: 0.67
Nodes (4): checkElementRadialSpotlight(), checkElementRadialSpotlightDOM(), elementGradientValue(), spotlightLabel()

### Community 306 - "runHook"
Cohesion: 0.11
Nodes (34): ACK_EXTS, ALLOWED_EXTS, bumpEditCount(), coLocatedStylesheets(), dedupeAgainstCache(), depthIsSet(), designSystemOptions(), ensureFile() (+26 more)
...
### Community 311 - "StudioFlow product specification"
Cohesion: 0.25
...
### Community 313 - "20260728145920_project_lifecycle_workflow.sql"
Cohesion: 0.32
...
### Community 315 - "20260729200758_project_activity_history.sql"
Cohesion: 0.32
...
### Community 316 - "20260805212420_structured_project_metadata.sql"
Cohesion: 0.36
...
### Community 317 - "20260821130000_project_templates.sql"
Cohesion: 0.36
...
### Community 318 - "20260902140546_google_calendar_automatic_reconciliation.sql"
Cohesion: 0.29
...
### Community 320 - "20260910112451_review_note_privacy.sql"
Cohesion: 0.36
...
### Community 321 - "20260912124803_equipment_reference_catalog.sql"
Cohesion: 0.25
Nodes (3): public.equipment_catalog_manufacturers, public.equipment_catalog_products, public.equipment_catalog_sync_state

### Community 322 - "20260913214647_add_crm_follow_up_state.sql"
Cohesion: 0.36
...
### Community 323 - "calendar-event-form.ts"
Cohesion: 0.11
Nodes (39): EventForm(), TimeOffForm(), addCalendarDays(), CalendarEventFormValues, createCalendarEventFormValues(), getAllDayEventBounds(), getSiteVisitTitle(), getWorkMakeupTitle() (+31 more)

### Community 324 - "record_finance_trip_entry"
Cohesion: 0.20
Nodes (15): add_finance_entry, allocate_finance_payment, begin_finance_planning, finance_categories, finance_valuation, record_finance_movement, record_finance_trip_entry, release_finance_allocation (+7 more)

### Community 325 - "queries/submissions.ts"
Cohesion: 0.19
Nodes (11): OfficeSubmissionsPage(), CommentRow, getSubmissionComments(), getSubmissionsData(), person(), SubmissionComment, SubmissionDetail, SubmissionRow (+3 more)

### Community 326 - "Generate Report"
Cohesion: 0.29
...
### Community 327 - "Cognitive Load Assessment"
Cohesion: 0.29
Nodes (7): Cognitive Load Assessment, Cognitive Load Checklist, Extraneous Load: Bad Design, Germane Load: Learning Effort, Intrinsic Load: The Task Itself, The Working Memory Rule, Three Types of Cognitive Load

### Community 328 - "Impeccable Manual Edit Applier"
Cohesion: 0.29
Nodes (6): Checks, Entry Atomicity, Impeccable Manual Edit Applier, Input Contract, Output Contract, Workflow

### Community 329 - "SAFE_TAGS"
Cohesion: 0.11
Nodes (22): checkElementMotion(), checkElementMotionDOM(), checkMotion(), checkPageTypography(), checkTypography(), isBrandFontOnOwnDomain(), firstOverusedGoogleFont(), checkElementMotion() (+14 more)

### Community 330 - "HTML Slide Template"
Cohesion: 0.29
Nodes (6): Animation Classes, Background Images, Base Structure, Chart.js Integration, CSS Variables Reference, HTML Slide Template

### Community 331 - "detect_domain"
Cohesion: 0.43
Nodes (3): detect_domain(), Auto-detect the most relevant domain from query. Matches are weighted by…, TestDomainDetection

### Community 332 - "How to Use This Skill"
Cohesion: 0.29
...
### Community 337 - "20260802192102_studio_checklist_templates.sql"
Cohesion: 0.38
...
### Community 338 - "20260813120000_studio_member_lifecycle.sql"
Cohesion: 0.52
...
### Community 339 - "20260817172631_leaderboard_bonus_rules.sql"
Cohesion: 0.38
...
### Community 340 - "20260821100000_stage_progress_methods.sql"
Cohesion: 0.43
...
### Community 341 - "20260830130000_google_calendar_phase_one.sql"
Cohesion: 0.38
...
### Community 342 - "Diagnostic Scan"
Cohesion: 0.33
Nodes (6): 1. Accessibility (VoiceOver / TalkBack), 2. Performance, 3. Appearance & Theming, 4. Platform Conformance (CRITICAL), 5. Adaptivity, Diagnostic Scan

### Community 343 - "bolder.md"
Cohesion: 0.33
Nodes (5): Before you finish, Scope is sovereign, The amplification, The skeleton test, Why it reads flat

### Community 344 - "ukrainian-phone.ts"
Cohesion: 0.35
...
### Community 345 - "Slides"
Cohesion: 0.33
Nodes (5): References (Knowledge Base), Routing, Slides, Subcommands, When to Use

### Community 346 - "Supabase Postgres Best Practices"
Cohesion: 0.33
Nodes (5): How to Use, References, Rule Categories by Priority, Supabase Postgres Best Practices, When to Apply

### Community 347 - "Pre-Delivery Checklist"
Cohesion: 0.33
...
### Community 349 - "Equipment reference catalog"
Cohesion: 0.33
...
### Community 368 - "Q: Trace Office submission comments from database schema and RLS through server mutation and client drawer Realtime synchronization"
Cohesion: 0.40
...
### Community 369 - "Q: Fix the leaderboard previous period leader calculation."
Cohesion: 0.40
Nodes (4): Answer, Outcome, Q: Fix the leaderboard previous period leader calculation., Source Nodes

### Community 370 - "Q: Investigate and fix the stale-session/auth-resume failure after StudioFlow is left open"
Cohesion: 0.40
...
### Community 371 - "Q: Which modules own the Finance information architecture, Accounts configuration, and Movements ledger UX?"
Cohesion: 0.40
...
### Community 372 - "Q: Which modules own the Finance Expected Payments timeline, create flow, and Movements presentation?"
Cohesion: 0.40
Nodes (4): Answer, Outcome, Q: Which modules own the Finance Expected Payments timeline, create flow, and Movements presentation?, Source Nodes

### Community 373 - "Q: Which modules own Finance Overview, shared navigation, and canonical chart reporting?"
Cohesion: 0.40
Nodes (4): Answer, Outcome, Q: Which modules own Finance Overview, shared navigation, and canonical chart reporting?, Source Nodes

### Community 374 - "package.json"
Cohesion: 0.40
Nodes (4): name, packageManager, private, version

### Community 375 - "maintenance-notifications/route.ts"
Cohesion: 0.60
Nodes (3): GET(), hasValidCronAuthorization(), mocks

### Community 376 - "legal-pages.test.ts"
Cohesion: 0.40
Nodes (4): englishMessagesPath, layoutPath, privacyPath, termsPath

### Community 377 - "theme-switch.test.ts"
Cohesion: 0.40
Nodes (4): layoutPath, shellControlPath, stylesPath, switchPath

### Community 378 - "floor-plan-view.test.ts"
Cohesion: 0.40
Nodes (4): actions, floorPlan, query, workspace

### Community 379 - "project-code-visibility.test.ts"
Cohesion: 0.40
Nodes (4): archivePath, projectContextPath, projectDetailsPath, projectListPath

### Community 380 - "project-template-stage-dialog.test.ts"
Cohesion: 0.40
Nodes (4): boardPath, dialogPath, mutationPath, projectPagePath

### Community 381 - "notification-insert-shape-migration.test.ts"
Cohesion: 0.50
Nodes (4): insertParts(), notificationsMigration, patchMigration, topLevelExpressions()

### Community 383 - "Business trips"
Cohesion: 0.36
Nodes (9): Finance business-trip projection, Business trips, Calendar-owned trip metadata, Calendar trip source lifecycle, Immutable trip entry traveler coverage, Inline trip entry editing, Multi-traveler per diem coverage, Trip expense sheet (+1 more)

### Community 385 - "20260818120000_add_contractor_category_colors.sql"
Cohesion: 0.50
...
### Community 387 - "20260829180000_add_meeting_presentation_mode.sql"
Cohesion: 0.50
...
### Community 391 - "20260922194947_task_status_history.sql"
Cohesion: 0.60
Nodes (4): private.record_task_status_period(), public.task_status_periods, record_task_status_period_after_insert, record_task_status_period_after_status_change

### Community 394 - "queries/office-assignments.ts"
Cohesion: 0.23
Nodes (9): kyivToday(), OfficeAssignmentsPage(), AssignmentRow, getOfficeAssignmentsData(), OfficeAssignmentItem, toPerson(), SubmissionPerson, OfficeAssignmentPriority (+1 more)

### Community 395 - "browser-script-parts.mjs"
Cohesion: 0.33
...
### Community 405 - "contractor-permissions.contract.test.ts"
Cohesion: 0.50
Nodes (3): actionsPath, directoryPath, pagePath

### Community 406 - "stage-configuration-controls.test.ts"
Cohesion: 0.50
Nodes (3): boardPath, dialogPath, mutationPath

### Community 407 - "task-details-drawer.test.ts"
Cohesion: 0.50
Nodes (3): collaboratorControlPath, deadlineEditorPath, drawerPath

### Community 408 - "task-drawer-reopen.test.ts"
Cohesion: 0.50
Nodes (3): myTasksPath, projectBoardPath, taskDrawerCallers

### Community 409 - "equipment-history.integration.test.ts"
Cohesion: 0.22
Nodes (6): accounts, clients, measure(), mocks, requests, studios

### Community 410 - "auth-autocomplete.test.ts"
Cohesion: 0.50
Nodes (3): loginPath, recoveryPath, resetPath

### Community 411 - "crm-lead-follow-up-migration.test.ts"
Cohesion: 0.50
Nodes (3): enumMigration, stateMigration, statusSyncMigration

### Community 412 - "crm-lead-metadata-migration.test.ts"
Cohesion: 0.50
Nodes (3): constraintMigrationPath, currencyMigrationPath, migrationPath

### Community 413 - "project-city-geonames-mutation.test.ts"
Cohesion: 0.50
Nodes (3): createActionPath, editActionPath, projectQueryPath

### Community 414 - "public-table-privileges-migration.test.ts"
Cohesion: 0.50
Nodes (3): migrationPath, taskDeleteMigrationPath, taskStatusInsertMigrationPath

### Community 416 - "20260806175022_add_project_city_geonames_id.sql"
Cohesion: 0.67
Nodes (3): enforce_structured_project_metadata_before_update, private.enforce_structured_project_metadata(), public.projects

### Community 420 - "20260818180000_canonical_project_types.sql"
Cohesion: 0.67
Nodes (3): enforce_structured_project_metadata_before_update, private.enforce_structured_project_metadata(), public.projects

### Community 426 - "20260910120551_task_deadline_completion_history.sql"
Cohesion: 0.67
...
### Community 435 - "finance_project_terms"
Cohesion: 0.39
...
### Community 437 - "finance-forecast.spec.ts"
Cohesion: 0.22
Nodes (6): actors, bank, client, local, login(), studio

### Community 438 - "finance-opening-valuation.spec.ts"
Cohesion: 0.22
Nodes (7): actors, bank, client, dollars, local, login(), studio

### Community 439 - "translation-payload.spec.ts"
Cohesion: 0.22
Nodes (7): accounts, login(), moduleMarkers, scripts(), service, settings, studioId

### Community 440 - "finance-payroll-setup.spec.ts"
Cohesion: 0.25
Nodes (6): actors, bank, client, local, login(), studio

### Community 441 - "profile-shell.spec.ts"
Cohesion: 0.25
Nodes (7): accounts, login(), moduleMarkers, scripts(), service, settings, studioId

## Knowledge Gaps
- **2514 isolated node(s):** `fs`, `path`, `fs`, `path`, `fs` (+2509 more)
...
- **Why does `buffer` connect `buffer` to `candidates-workspace.tsx`, `equipment-catalog/sync.ts`, `generate-image.mjs`, `submissions/actions.ts`, `maintenance-notifications/route.ts`, `hook.mjs`, `live-server.mjs`, `tag-strategy.mjs`, `live-wrap.mjs`, `detect-csp.mjs`, `google-calendar/diagnostics.ts`, `embed-prompt.mjs`, `equipment-history.integration.test.ts`, `manual-edit-routes.mjs`, `detect-antipatterns.mjs`, `hook-before-edit.mjs`?**
  _High betweenness centrality (0.123) - this node is a cross-community bridge._
- **Why does `handleKeyDown()` connect `setLiveState` to `live-browser.js`, `el`, `initPageChat`, `connectSSE`, `project-task-board.tsx`, `initGlobalBar`, `dialog.tsx`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **Why does `el()` connect `el` to `live-browser.js`, `checks.mjs`, `initPageChat`, `SAFE_TAGS`, `detect-html.mjs`, `injected/index.mjs`, `detect-antipatterns-browser.js`, `connectSSE`, `design-system.mjs`, `collectBrowserFindings`, `parseAnyColor`, `initGlobalBar`, `svelte-ast.mjs`, `setLiveState`?**
...
- **Should `Finance` be split into smaller, more focused modules?**
  _Cohesion score 0.03295075897815624 - nodes in this community are weakly interconnected._
