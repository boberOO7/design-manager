...
## Corpus Check
- 621 files · ~604,340 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6966 nodes · 14561 edges · 393 communities (318 shown, 75 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 173 edges (avg confidence: 0.64)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `20b938c2`
...
### Community 2 - "forgot-password/actions.ts"
Cohesion: 0.32
...
Cohesion: 0.12
Nodes (31): firstExisting(), getDesignSidecarCandidates(), getImpeccableDir(), getLegacyLiveConfigPath(), getLegacyLiveServerPath(), getLegacyLiveSessionsDir(), getLiveAnnotationsDir(), getLiveConfigPath() (+23 more)
...
Cohesion: 0.07
Nodes (58): ProjectProgressSettings(), AdminDashboard, DashboardData, DashboardDeadline, DashboardProjectRow, DashboardTaskForDrawer, DashboardTaskRow, EmployeeDashboard (+50 more)

### Community 8 - "lib/calendar.ts"
Cohesion: 0.09
Nodes (39): AgendaView(), CalendarWorkspace(), calendarItemTimestamp(), CalendarTimeOffTitleLabels, canAttendCalendarEvent(), compareCanonical(), deduplicateCalendarItems(), DEFAULT_CALENDAR_FILTERS (+31 more)
...
Cohesion: 0.05
Nodes (97): Context, DELETE(), PATCH(), PATCH(), POST(), PATCH(), PATCH(), PATCH() (+89 more)

### Community 12 - "profile-avatar-editor.tsx"
Cohesion: 0.09
Nodes (34): GET(), TeamPage(), ProfileAvatarEditor(), ProfileAvatarEditorProps, LeaderboardPeriodSwitcher(), Member, TeamDirectory(), TeamMemberCard() (+26 more)
...
### Community 34 - "administration-workspace.tsx"
Cohesion: 0.24
...
Cohesion: 0.05
Nodes (68): BonusBadge(), formatArea(), LeaderboardPage(), LeaderboardBonusMenu(), dashboardMetrics, employeeWorkload, getAccessibleProjects(), getDashboardMetrics() (+60 more)

### Community 53 - "button.tsx"
Cohesion: 0.06
Nodes (36): LoginPage(), ChecklistTemplateManager(), createStage(), Draft, SortableStageRow(), stageKeyboardSensor, stagePointerSensor, stageSensors (+28 more)
...
Cohesion: 0.08
Nodes (29): react, react, ProjectCreationModal(), ProjectEditModal(), Field(), ProjectFormModal(), ProjectForm(), ProjectFormAction (+21 more)
...
Cohesion: 0.05
Nodes (87): ArchivePage(), Employee(), ProjectDetails(), ProjectWorkspace(), AddTaskDialog, AddTaskDialogHandle, DashboardTaskList(), MyTasksList() (+79 more)
...
Cohesion: 0.04
Nodes (62): ProjectsPage(), DeadlineSummary(), ProjectContextActions(), ProjectContextBand(), ProjectContextProject, useProjectLifecycle(), ProjectLifecycleControls(), ProjectListControls() (+54 more)
...
Cohesion: 0.06
Nodes (67): getDesignSidecarPath(), assembleLiveBrowserScript(), assertLiveBrowserScriptParts(), LIVE_BROWSER_SCRIPT_PARTS, readLiveBrowserScriptParts(), resolveLiveBrowserScriptParts(), eventPriority(), selectAvailablePendingEvent() (+59 more)

### Community 119 - "team/actions.ts"
Cohesion: 0.09
Nodes (29): Admin(), ProjectMemberActionState, inviteEmployee(), isExistingAuthUserError(), AddProjectMemberForm(), ProjectTeamSection(), RemoveProjectMemberButton(), InviteEmployeeForm() (+21 more)
...
### Community 194 - "city-combobox.tsx"
Cohesion: 0.42
...
### Community 267 - "applyDeferredSvelteComponentAccepts"
Cohesion: 0.60
...
### Community 268 - "cn"
Cohesion: 0.05
Nodes (61): Deadlines(), SpaceLogoFull(), ClassificationOption, ContractorCategoryCombobox(), ContractorSubcategoryCombobox(), CreatableClassificationCombobox(), getUniqueContractorCategories(), getUniqueContractorSubcategories() (+53 more)
...
### Community 283 - "supabase/proxy.ts"
Cohesion: 0.60
...
Cohesion: 0.17
Nodes (16): CalendarSupabaseClient, getVerifiedActiveAdminMembership(), POST(), CalendarEventInsertPayload, createCalendarEventInsertPayload(), eventInput, membership, VerifiedCalendarEventAdminMembership (+8 more)
...
## Knowledge Gaps
- **2016 isolated node(s):** `fs`, `path`, `fs`, `path`, `fs` (+2011 more)
...
- **Why does `el()` connect `el` to `detect-text.mjs`, `setLiveState`, `live-browser.js`, `constants.mjs`, `checks.mjs`, `detect-antipatterns-browser.js`, `collectVisualContrastCandidates`, `mountSvelteComponentVariant`, `design-system.mjs`, `connectSSE`, `initGlobalBar`, `css-cascade.mjs`, `svelte-ast.mjs`, `initPageChat`, `injected/index.mjs`, `collectBrowserFindings`?**
