...
## Corpus Check
- 625 files · ~607,646 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6975 nodes · 14574 edges · 401 communities (326 shown, 75 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 173 edges (avg confidence: 0.64)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `119cddf5`
...
## Communities (401 total, 75 thin omitted)

### Community 0 - "live-status.mjs"
Cohesion: 0.20
...
Cohesion: 0.09
Nodes (24): CityCombobox(), isCityResult(), SearchState, DeadlineSummary(), ProjectContextActions(), ProjectContextBand(), ProjectContextProject, ProjectEditModal() (+16 more)

### Community 3 - "impeccable-paths.mjs"
Cohesion: 0.16
Nodes (25): resolveProjectRoot(), firstExisting(), getDesignSidecarCandidates(), getDesignSidecarPath(), getImpeccableDir(), getLegacyLiveAnnotationsDir(), getLegacyLiveServerPath(), getLegacyLiveSessionsDir() (+17 more)
...
Cohesion: 0.13
Nodes (22): applyEditing(), buildInsertPlaceholderSnapshotFromDom(), buildLocatorForLeaf(), buildPickedAnchorSnapshot(), captureAndEmit(), checkpointPayload(), copyEditContainerContext(), copyEditLeafContext() (+14 more)

### Community 7 - "queries/dashboard.ts"
Cohesion: 0.08
Nodes (56): ProjectProgressSettings(), AdminDashboard, DashboardData, DashboardDeadline, DashboardProjectRow, DashboardTaskForDrawer, DashboardTaskRow, EmployeeDashboard (+48 more)

### Community 8 - "lib/calendar.ts"
Cohesion: 0.10
Nodes (35): AgendaView(), CalendarWorkspace(), calendarItemTimestamp(), CalendarTimeOffTitleLabels, canAttendCalendarEvent(), compareCanonical(), deduplicateCalendarItems(), DEFAULT_CALENDAR_FILTERS (+27 more)
...
### Community 11 - "getCurrentUserProfile"
Cohesion: 0.13
Nodes (14): AccessUnavailablePage(), ContractorsPage(), AppLayout(), generateMetadata(), MyTasksPage(), AppHeader(), PageHeader(), resolveActiveStudioMembership (+6 more)

### Community 12 - "profile-avatar-editor.tsx"
Cohesion: 0.13
...
Cohesion: 0.10
Nodes (39): Context, DELETE(), PATCH(), PATCH(), responseSchema, PATCH(), PATCH(), deleteContractor() (+31 more)

### Community 17 - "html-token-validator.py"
Cohesion: 0.14
Nodes (24): get_context(), is_allowed_exception(), is_allowed_rgba(), is_inside_block(), load_css_variables(), main(), print_result(), print_summary() (+16 more)

### Community 18 - "calendar-item.ts"
Cohesion: 0.15
Nodes (18): Context, PATCH(), CalendarSupabaseClient, getVerifiedTimeOffMembership(), POST(), VerifiedTimeOffMembership, getNormalizedTimeOffRequest(), canTransitionTimeOff() (+10 more)

### Community 19 - "getActiveStudioMembership"
Cohesion: 0.12
Nodes (26): PATCH(), POST(), createContractor(), getContractorValues(), nullable(), parseForm(), resolveContractorClassification(), updateContractor() (+18 more)

### Community 20 - "semantic-styles.ts"
Cohesion: 0.14
Nodes (24): ProjectSignals(), DashboardTaskList(), MyTasksList(), sections, StatusColumnHeader(), TaskCardContent(), TaskDetailsDrawer(), ProjectHealth (+16 more)
...
Cohesion: 0.11
Nodes (28): CalendarPill(), dateLabel(), DayDetails(), Drawer, eventTypeKey, isCalendarItem(), isMutationResult(), ItemPanel() (+20 more)
...
Cohesion: 0.16
Nodes (17): createProject(), dateSchema, EditProjectFormValues, editProjectSchema, getOptionalString(), getProjectFormInput(), getProjectTypeDisplayName(), isProjectTypeKey() (+9 more)
...
### Community 37 - "notification-bell.tsx"
Cohesion: 0.17
...
Cohesion: 0.09
Nodes (37): GET(), ProjectDetails(), TeamPage(), InviteEmployeeForm(), Member, TeamDirectory(), DirectoryRow, getCurrentStudioTeam() (+29 more)
...
Cohesion: 0.05
Nodes (70): BonusBadge(), formatArea(), LeaderboardPage(), LeaderboardPeriodSwitcher(), dashboardMetrics, employeeWorkload, getAccessibleProjects(), getDashboardMetrics() (+62 more)

### Community 53 - "checklist-template-manager.tsx"
Cohesion: 0.18
...
### Community 54 - "SAFE_TAGS"
Cohesion: 0.12
Nodes (26): checkColors(), checkElementAIPaletteDOM(), checkElementGlow(), checkElementMotion(), checkElementMotionDOM(), checkElementRadialSpotlight(), checkElementRadialSpotlightDOM(), checkGlow() (+18 more)
...
Cohesion: 0.07
Nodes (56): DELETE(), PATCH(), POST(), PATCH(), PATCH(), PATCH(), createProjectTask(), deleteProjectTask() (+48 more)
...
Cohesion: 0.06
Nodes (42): ProjectMemberActionState, LoginPage(), LeaderboardBonusSettings(), SignOutButton(), LanguageSelector(), ShellControl, ShellControlProps, LeaderboardBonusMenu() (+34 more)
...
Cohesion: 0.11
Nodes (22): ChecklistItemRow(), ChecklistAutosaveStore, ChecklistChange, ChecklistMutationResult, ChecklistSnapshot, getChecklistAutosaveStore(), isChecklistMutationResult(), Listener (+14 more)
...
### Community 81 - "database.types.ts"
Cohesion: 0.11
...
Cohesion: 0.07
Nodes (57): AddTaskDialog, AddTaskDialogHandle, BoardColumn(), getColumnDropId(), getDropTarget(), interactiveSelector, keyboardSensor, pointerSensor (+49 more)
...
### Community 119 - "team/actions.ts"
Cohesion: 0.10
Nodes (28): addProjectMember(), getFormString(), removeProjectMember(), revalidateProjectMembership(), inviteEmployee(), isExistingAuthUserError(), removeStudioMember(), restoreStudioMember() (+20 more)

### Community 121 - "detect-html.mjs"
Cohesion: 0.06
Nodes (43): mergeDesignSystemFindings(), runTextContentAnalyzers(), applyStaticDeclaration(), buildBorderOverrideMap(), buildStaticStyleMap(), buildStaticWindow(), collectStaticCssRules(), collectStaticCssText() (+35 more)
...
Cohesion: 0.15
Nodes (14): CalendarQueryInput, timeOffRequestTypeKey, timeOffStatusKey, CALENDAR_EVENT_INVITATION_STATUSES, CalendarBase, CalendarEventInvitationStatus, CalendarEventInvitee, CalendarFilters (+6 more)
...
### Community 225 - "calendar-event-form.ts"
Cohesion: 0.20
Nodes (14): EventForm(), CalendarEventFormValues, createCalendarEventFormValues(), getAllDayEventBounds(), splitWallDateTime(), baseValues, toCalendarEventMutationPayload(), getKyivDateTime() (+6 more)
...
### Community 234 - "administration-workspace.tsx"
Cohesion: 0.24
...
### Community 235 - "addCalendarDays"
Cohesion: 0.26
Nodes (13): CalendarPage(), validDate(), getCalendarData(), addCalendarDays(), getInclusiveAllDayEndDate(), getCalendarRange(), getMonthGrid(), instantToDateOnly() (+5 more)
...
### Community 239 - "inline-ignores.mjs"
Cohesion: 0.40
...
### Community 267 - "validate-tokens.cjs"
Cohesion: 0.24
Nodes (11): extensions, formatReport(), fs, getFiles(), main(), parseArgs(), path, patterns (+3 more)

### Community 268 - "contractor-directory.tsx"
Cohesion: 0.14
Nodes (24): ClassificationOption, ContractorCategoryCombobox(), ContractorSubcategoryCombobox(), getUniqueContractorCategories(), getUniqueContractorSubcategories(), uniqueOptions(), ContractorAction, ContractorDirectory() (+16 more)
...
### Community 271 - "appendSanitizedCssRule"
Cohesion: 0.24
...
### Community 288 - "Android platform"
Cohesion: 0.29
...
### Community 290 - "checkElementGptBorderShadowDOM"
Cohesion: 0.38
...
### Community 294 - "Impeccable Finish Reviewer"
Cohesion: 0.29
...
### Community 299 - "$impeccable hooks"
Cohesion: 0.33
...
### Community 312 - "cn"
Cohesion: 0.07
Nodes (37): ArchivePage(), Admin(), DashboardPage(), Deadlines(), Employee(), SpaceLogoFull(), StudioFlowMark(), CreatableClassificationCombobox() (+29 more)
...
### Community 325 - "checkHtmlPatterns"
Cohesion: 0.13
...
### Community 379 - "mountSvelteComponentVariant"
Cohesion: 0.10
...
## Knowledge Gaps
- **2019 isolated node(s):** `fs`, `path`, `fs`, `path`, `fs` (+2014 more)
...
- **Why does `el()` connect `el` to `setLiveState`, `live-browser.js`, `constants.mjs`, `checks.mjs`, `detect-antipatterns-browser.js`, `initPageChat`, `design-system.mjs`, `parseRgb`, `connectSSE`, `initGlobalBar`, `SAFE_TAGS`, `mountSvelteComponentVariant`, `detect-html.mjs`, `svelte-ast.mjs`, `isCardLike`, `injected/index.mjs`, `collectBrowserFindings`?**
  _High betweenness centrality (0.097) - this node is a cross-community bridge._
- **Why does `handleKeyDown()` connect `setLiveState` to `live-browser.js`, `button.tsx`, `connectSSE`, `semantic-styles.ts`, `initGlobalBar`, `el`, `initPageChat`?**
