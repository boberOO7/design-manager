...
## Corpus Check
- 727 files · ~660,020 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7299 nodes · 15341 edges · 431 communities (332 shown, 99 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 183 edges (avg confidence: 0.63)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5d7798df`
...
## Communities (431 total, 99 thin omitted)
...
Cohesion: 0.06
Nodes (50): PATCH(), getProjectView(), ProjectDetails(), ProjectDetailsPage(), ProjectView, TeamPage(), DeadlineSummary(), ProjectContextBand() (+42 more)

### Community 8 - "contractor-directory.tsx"
Cohesion: 0.07
Nodes (47): createContractor(), getContractorValues(), nullable(), parseForm(), resolveContractorClassification(), updateContractor(), ClassificationOption, ContractorCategoryCombobox() (+39 more)
...
Cohesion: 0.08
Nodes (32): CalendarPill(), dateLabel(), DayDetails(), Drawer, EventForm(), eventTypeKey, globalStyles, InviteePicker() (+24 more)
...
### Community 28 - "cn"
Cohesion: 0.08
Nodes (34): ArchivePage(), Admin(), Deadlines(), Employee(), SpaceLogoFull(), StudioFlowMark(), DashboardSection(), MetricStrip() (+26 more)
...
Cohesion: 0.04
Nodes (105): Context, DELETE(), isDateOnly(), isRecord(), parseDayOff(), PATCH(), requireAdmin(), isDateOnly() (+97 more)
...
Cohesion: 0.04
Nodes (109): AddTaskDialog, AddTaskDialogHandle, DashboardTaskList(), MyTasksList(), sections, BoardColumn(), BulkAssignmentScope, BulkColumnDragHandle() (+101 more)

### Community 38 - "city-provider.ts"
Cohesion: 0.18
Nodes (18): AppLocale, locales, resolveLocale(), GeoNamesPlace, getGeoNamesCityPlace(), isRecord(), searchCities(), textValue() (+10 more)

### Community 39 - "calendar-event-form.ts"
Cohesion: 0.15
Nodes (30): CalendarPage(), validDate(), CalendarQueryInput, getCalendarData(), addCalendarDays(), createCalendarEventFormValues(), getAllDayEventBounds(), getInclusiveAllDayEndDate() (+22 more)
...
Cohesion: 0.04
Nodes (87): BonusBadge(), formatArea(), LeaderboardPage(), MyTasksPage(), LeaderboardBonusSettings(), LeaderboardBonusMenu(), LeaderboardPeriodSwitcher(), dashboardMetrics (+79 more)
...
### Community 58 - "collectNumberedSectionLabelCandidates"
Cohesion: 0.20
...
Cohesion: 0.11
Nodes (19): CalendarEventFormValues, getSiteVisitTitle(), baseValues, CalendarEventInsertPayload, createCalendarEventInsertPayload(), eventInput, membership, VerifiedCalendarEventMembership (+11 more)
...
### Community 100 - "[requestId]/route.ts"
Cohesion: 0.24
...
Cohesion: 0.04
Nodes (73): ProjectMemberActionState, inviteEmployee(), isExistingAuthUserError(), removeStudioMember(), restoreStudioMember(), updateStudioMemberProfile(), AddProjectMemberForm(), ProjectTeamSection() (+65 more)
...
Cohesion: 0.07
Nodes (47): browserColorsClose(), browserDesignSystemConfig(), browserHasDirectText(), browserPrimaryFont(), browserRadiusTokens(), browserSampleText(), buildSelectorSegment(), checkBrowserDesignSystemSources() (+39 more)

### Community 216 - "profile-avatar-editor.tsx"
Cohesion: 0.26
Nodes (8): GET(), ProfileAvatarEditor(), ProfileAvatarEditorProps, COUNTRY_CODES, CountryCode, countryCodeSet, getCountryOptions(), isCountryCode()
...
Cohesion: 0.14
Nodes (29): mergeDesignSystemFindings(), detectUrl(), launchBrowser(), measureContentHiddenAfterReveal(), runVisualContrastFallback(), serializeDesignSystemForBrowser(), runTextContentAnalyzers(), collectStaticCssText() (+21 more)

### Community 231 - "types/calendar.ts"
Cohesion: 0.10
Nodes (27): CalendarSupabaseClient, getVerifiedTimeOffMembership(), POST(), VerifiedTimeOffMembership, TimeOffForm(), getNormalizedTimeOffRequest(), CalendarCreatorRole, canCreateTimeOffRequestType() (+19 more)
...
Cohesion: 0.09
Nodes (44): checkBorders(), checkCreamPalette(), checkEdgeFlushCardsDOM(), checkElementBlinkingCursorDOM(), checkElementBorders(), checkElementBordersDOM(), checkElementColors(), checkElementColorsDOM() (+36 more)
...
Cohesion: 0.05
Nodes (60): createProject(), getSelectedTemplateId(), getStageAssignees(), ProjectTemplatesPage(), ProjectContextActions(), ProjectCreationModal(), ProjectEditModal(), Field() (+52 more)
...
### Community 261 - "task.ts"
Cohesion: 0.08
Nodes (40): PATCH(), createProjectTask(), deleteProjectTask(), revalidateMyTasks(), revalidateTaskCreationRoutes(), revalidateTaskDeletionRoutes(), TaskDeleteActionState, updateTaskStatus() (+32 more)
...
Cohesion: 0.05
Nodes (69): ProjectsPage(), ProjectListControls(), controlsPath, healthKeys, PrioritySignal(), ProjectDesktopRow(), ProjectItem, ProjectList() (+61 more)
...
### Community 312 - "city-combobox.tsx"
Cohesion: 0.42
...
### Community 316 - "foreground"
Cohesion: 0.67
Nodes (3): foreground, $type, $value

### Community 317 - "muted-foreground"
Cohesion: 0.67
...
### Community 372 - "checkElementGptBorderShadowDOM"
Cohesion: 0.38
...
### Community 402 - "avatar-crop-step.tsx"
Cohesion: 0.38
...
### Community 413 - "checkElementBordersDOM"
Cohesion: 0.47
...
## Knowledge Gaps
- **2113 isolated node(s):** `fs`, `path`, `fs`, `path`, `fs` (+2108 more)
...
- **Why does `el()` connect `el` to `SAFE_TAGS`, `setLiveState`, `live-browser.js`, `detect-html.mjs`, `parseAnyColor`, `checks.mjs`, `detect-antipatterns-browser.js`, `design-system.mjs`, `parseRgb`, `constants.mjs`, `connectSSE`, `initGlobalBar`, `css-cascade.mjs`, `svelte-ast.mjs`, `initPageChat`, `injected/index.mjs`, `collectBrowserFindings`?**
  _High betweenness centrality (0.101) - this node is a cross-community bridge._
- **Why does `handleKeyDown()` connect `setLiveState` to `live-browser.js`, `team/actions.ts`, `connectSSE`, `task-details-drawer.tsx`, `initGlobalBar`, `el`, `initPageChat`?**
