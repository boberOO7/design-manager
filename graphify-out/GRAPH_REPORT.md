...
## Corpus Check
- 966 files · ~749,993 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8136 nodes · 17470 edges · 647 communities (461 shown, 186 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 194 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `46ec1a4e`
...
## Communities (647 total, 186 thin omitted)
...
Cohesion: 0.06
Nodes (44): react, react, ChecklistTemplateManager(), createStage(), Draft, SortableStageRow(), stageKeyboardSensor, stagePointerSensor (+36 more)
...
Cohesion: 0.04
Nodes (74): PATCH(), PATCH(), PATCH(), PATCH(), DELETE(), PATCH(), POST(), PATCH() (+66 more)
...
Cohesion: 0.06
Nodes (53): checkClippedOverflow(), checkElementClippedOverflow(), checkElementClippedOverflowDOM(), checkElementItalicSerif(), checkElementItalicSerifDOM(), checkElementMotion(), checkElementMotionDOM(), checkElementOversizedH1() (+45 more)
...
Cohesion: 0.08
Nodes (42): PATCH(), ProjectContextProject, LifecycleContext, ProjectLifecycleProvider(), useProjectLifecycle(), ProjectLifecycleControls(), ProjectWorkspace(), DraftStage (+34 more)

### Community 13 - "projects/page.tsx"
Cohesion: 0.07
Nodes (40): ProjectsPage(), ProjectListControls(), controlsPath, healthKeys, PrioritySignal(), ProjectDesktopRow(), ProjectItem, ProjectList() (+32 more)
...
Cohesion: 0.06
Nodes (51): AddTaskDialog, AddTaskDialogHandle, sections, BoardColumn(), BulkAssignmentScope, BulkColumnDragHandle(), BulkDragSource, DraggableTaskCard() (+43 more)

### Community 17 - "project-template-manager.tsx"
Cohesion: 0.07
Nodes (42): ProjectCreationModal(), ProjectEditModal(), Field(), ProjectFormModal(), ProjectForm(), ProjectFormAction, ProjectFormDefaults, TemplateSummary() (+34 more)

### Community 18 - "contractor-directory.tsx"
Cohesion: 0.07
...
Cohesion: 0.08
Nodes (40): configurationLabels(), CreateEquipmentDialog(), CreateKind, CreateWorkstationDialog(), EquipmentAttachPicker(), EquipmentDrawer(), EquipmentGroup(), equipmentIcons (+32 more)
...
### Community 27 - "[projectId]/page.tsx"
Cohesion: 0.09
Nodes (37): PATCH(), PATCH(), AppLayout(), generateMetadata(), archiveProject(), restoreProject(), revalidateProjectRoutes(), updateProject() (+29 more)
...
Cohesion: 0.09
Nodes (27): isDateOnly(), isRecord(), parseDayOff(), POST(), PATCH(), PATCH(), POST(), CrmLayout() (+19 more)

### Community 31 - "project.ts"
Cohesion: 0.13
Nodes (22): createProject(), createProjectFromLead(), createProjectRecord(), getSelectedTemplateId(), getStageAssignees(), ProjectTemplatesPage(), ProjectContextActions(), ProjectTemplateManager() (+14 more)
...
Cohesion: 0.08
Nodes (41): Admin(), DashboardPage(), Deadlines(), Employee(), ProjectDetails(), DashboardSection(), MetricStrip(), metricToneClasses (+33 more)

### Community 38 - "productivity.ts"
Cohesion: 0.09
Nodes (37): BonusBadge(), formatArea(), LeaderboardPage(), LeaderboardPeriodSwitcher(), getLeaderboardData(), getLeaderboardForPeriod(), getLeaderboardOverviewData(), getStudioLeaderboardBonusConfig() (+29 more)

### Community 39 - "lib/project-progress.ts"
Cohesion: 0.10
Nodes (31): ServicePanel(), DeadlineSummary(), ProjectContextBand(), ProjectDeadlines(), calculateOverallProjectProgress(), calculatePersonalProgress(), calculateProjectProgress(), calculateStageProgress() (+23 more)
...
Cohesion: 0.06
Nodes (45): CalendarChipIcon(), CalendarDetailHeaderIcon(), CalendarEventDetails(), CalendarPill(), dateLabel(), DayDetails(), Drawer, globalStyles (+37 more)

### Community 46 - "button.tsx"
Cohesion: 0.11
Nodes (19): AccessUnavailablePage(), LoginPage(), LeaderboardBonusSettings(), SignOutButton(), ShellControl, ShellControlProps, LeaderboardBonusMenu(), EligibleMember (+11 more)

### Community 47 - "equipment-form.tsx"
Cohesion: 0.11
Nodes (22): AccordionSection(), AnimatedFormContent(), EquipmentFormFields(), Section, EquipmentType, isEquipmentType(), capacity, CAPACITY_UNITS (+14 more)
...
### Community 50 - "buffer"
Cohesion: 0.11
Nodes (32): buffer, localFile(), main(), GET(), mocks, catalogError(), formatCatalogError(), CatalogImportRow (+24 more)
...
Cohesion: 0.24
Nodes (16): GeoNamesPlace, getGeoNamesCityPlace(), getLocalizedCityName(), isRecord(), searchCities(), textValue(), buildGeoNamesCityDetailsUrl(), buildGeoNamesCitySearchUrl() (+8 more)

### Community 59 - "team/actions.ts"
Cohesion: 0.07
Nodes (49): ProjectMemberActionState, inviteEmployee(), isExistingAuthUserError(), updateStudioMemberProfile(), TeamPage(), LeadDetail(), AddProjectMemberForm(), ProjectCountrySelect() (+41 more)

### Community 60 - "queries/calendar.ts"
Cohesion: 0.17
Nodes (25): CalendarPage(), validDate(), CalendarQueryInput, getCalendarData(), addCalendarDays(), deduplicateCalendarItems(), getInclusiveAllDayEndDate(), instantToDateOnly() (+17 more)
...
### Community 62 - "captureElementToBlob"
Cohesion: 0.13
...
Cohesion: 0.11
Nodes (24): AvatarCropStep(), ImageDimensions, loadImageDimensions(), readFileAsDataUrl(), ProfileAvatarEditor(), ProfileAvatarEditorProps, StudioMemberLifecycleControls(), TeamMemberCard() (+16 more)
...
Cohesion: 0.06
Nodes (47): OfficeSubmissionsPage(), CreateSubmissionDialog(), InboxFilter, initialCreateState, ManageSubmissionInput, RealtimeCommentDetailRow, sortComments(), statusStyle() (+39 more)
...
Cohesion: 0.04
Nodes (88): candidateContactRecord(), context(), createCandidate(), deleteCandidate(), deleteLead(), failure(), loadLeadHistory(), nullable() (+80 more)
...
### Community 79 - "assignments-workspace.tsx"
Cohesion: 0.07
Nodes (40): kyivToday(), OfficeAssignmentsPage(), kyivToday(), OfficeOverviewPage(), AssignmentAdminControls(), AssignmentDetailDrawer(), AssignmentRow(), AssignmentsWorkspace() (+32 more)
...
Cohesion: 0.23
Nodes (16): AdminPage(), AdministrationWorkspace(), getAdministrationData(), AdministrationModel, AdministrationRequest, applyAdministrationDecision(), canReceiveAdministrationModel(), effectiveDecisionTime() (+8 more)
...
Cohesion: 0.12
Nodes (21): completeEquipmentServiceSchema, EquipmentActionState, equipmentAssignmentSchema, equipmentDeleteSchema, equipmentFieldUpdateSchema, EquipmentInput, equipmentInputSchema, equipmentMaintenanceSchema (+13 more)
...
Cohesion: 0.08
Nodes (45): Context, DELETE(), PATCH(), POST(), PATCH(), responseSchema, calendarQuery, route (+37 more)
...
### Community 96 - "types/tasks.ts"
Cohesion: 0.10
Nodes (30): BulkTaskContextMenu(), makeFormValues(), attachDeadlineCompletions(), DeadlineCompletionRow, getMyTasks(), getProjectTasks(), MyTaskRow, normalizeMyTask() (+22 more)
...
Cohesion: 0.12
Nodes (25): isCalendarEventRelevantToUser(), asGoogleCalendarSyncError(), atGoogleCalendarStage(), addCounts(), CalendarEventRow, CalendarInviteRow, CalendarParticipantRow, getGoogleClient() (+17 more)
...
### Community 100 - "createAdminClient"
Cohesion: 0.20
Nodes (16): GET(), hasValidCronAuthorization(), GET(), hasValidCronAuthorization(), isReconnectRequiredError(), completeJob(), processGoogleCalendarReconciliationQueue(), ReconciliationJob (+8 more)
...
### Community 109 - "archive/page.tsx"
Cohesion: 0.12
Nodes (17): ArchivePage(), CrmCandidatesPage(), CrmLeadsPage(), MyTasksPage(), ProjectStatusAction(), PageHeader(), EmptyState(), ArchivedProject (+9 more)
...
Cohesion: 0.17
Nodes (23): callbackRedirect(), GET(), stateMatches(), GET(), POST(), GET(), POST(), getGoogleCalendarActor() (+15 more)
...
Cohesion: 0.09
Nodes (29): addBrowserFindings(), addVisualContrastFindings(), addVisualContrastResult(), analyzeVisualContrast(), analyzeVisualContrastCandidate(), buildSelectorSegment(), clearOverlays(), collectVisualContrastCandidates() (+21 more)
...
Cohesion: 0.23
Nodes (27): ContractorsPage(), createOfficeAssignment(), manageOfficeAssignment(), refreshOffice(), transitionOfficeAssignment(), assignEquipment(), completeEquipmentService(), createEquipment() (+19 more)
...
Cohesion: 0.13
Nodes (16): EquipmentPage(), EquipmentWorkspace(), useEquipmentRouting(), ActiveStudioMembership, EquipmentItem, EquipmentMember, EquipmentRow, EquipmentServiceEvent (+8 more)

### Community 134 - "app-header.tsx"
Cohesion: 0.22
Nodes (14): AppHeader(), iconFor(), NotificationBell(), getNotificationData(), NotificationData, NotificationItem, NotificationRow, formatNotificationRelativeTime() (+6 more)
...
### Community 140 - "cn"
Cohesion: 0.09
Nodes (26): SpaceLogoFull(), StudioFlowMark(), AppSidebar(), MobileNavigation(), CityCombobox(), isCityResult(), SearchState, ProjectNavigationLink() (+18 more)

### Community 141 - "member-actions.ts"
Cohesion: 0.18
Nodes (14): addProjectMember(), getFormString(), removeProjectMember(), revalidateProjectMembership(), removeStudioMember(), addProjectMemberSchema, idSchema, removeProjectMemberSchema (+6 more)
...
Cohesion: 0.13
Nodes (15): updateSession(), config, proxy(), ApplicationDatabase, PublicSchema, SelectedTaskBulkFunctions, CompositeTypes, Constants (+7 more)
...
### Community 165 - "time-off-labels.ts"
Cohesion: 0.13
Nodes (15): canTransitionTimeOff(), getTimeOffRequestPresentation(), requiresTimeOffReason(), TIME_OFF_REQUEST_PRESENTATION, TimeOffFieldLabelKey, TimeOffPlaceholderKey, TimeOffRequestPresentation, timeOffRequestTypeKey (+7 more)
...
Cohesion: 0.32
Nodes (6): requestPasswordRecovery(), ForgotPasswordForm(), getPasswordRecoveryInput(), PasswordRecoveryActionState, PasswordRecoveryField, passwordRecoverySchema
...
### Community 212 - "Non-Project Studio Work"
Cohesion: 0.08
Nodes (24): Atomic Mutating RPCs, Database-Enforced Cross-Client Invariants, Exact Task Selection RPCs, Office Tables, Category mapping, Controlled operator workflow, Equipment reference catalog, History, search and synchronization (+16 more)

### Community 213 - "checkElementDesignSystemDOM"
Cohesion: 0.15
...
### Community 227 - "collectNumberedSectionLabelCandidates"
Cohesion: 0.19
...
Cohesion: 0.24
Nodes (6): GET(), LanguageSelector(), AppLocale, isAppLocale(), locales, resolveLocale()
...
Cohesion: 0.07
Nodes (32): Active Studio Membership Resolver, Avatar Storage RLS Boundary, Caller-Context Table Writes, CRM Tables, Data API Grants and RLS, Database Architecture, Database Contract Tests, Database Domain Ownership Map (+24 more)
...
### Community 255 - "checkElementRadialSpotlightDOM"
Cohesion: 0.67
...
### Community 274 - "syncEditBadgeHitProxies"
Cohesion: 0.27
Nodes (10): bindEditBadgeProxy(), editBadgeProxyTargets(), initEditBadge(), initEditBadgeHitProxies(), positionEditBadge(), proxyMouseEvent(), setImportantStyle(), styleEditBadgeProxy() (+2 more)

### Community 275 - "instructions.mjs"
Cohesion: 0.40
...
### Community 327 - "secondary-foreground"
Cohesion: 0.67
...
## Knowledge Gaps
- **2060 isolated node(s):** `fs`, `path`, `fs`, `path`, `fs` (+2055 more)
...
- **Why does `el()` connect `el` to `css-cascade.mjs`, `checks.mjs`, `live-browser.js`, `collectBrowserFindings`, `connectSSE`, `injected/index.mjs`, `detect-antipatterns-browser.js`, `handleGo`, `design-system.mjs`, `constants.mjs`, `setLiveState`, `svelte-ast.mjs`, `initPageChat`, `collectVisualContrastCandidates`, `initGlobalBar`, `detect-html.mjs`?**
  _High betweenness centrality (0.106) - this node is a cross-community bridge._
- **Why does `handleKeyDown()` connect `setLiveState` to `live-browser.js`, `connectSSE`, `dashboard/page.tsx`, `project-task-board.tsx`, `el`, `dialog.tsx`, `initPageChat`, `initGlobalBar`?**
  _High betweenness centrality (0.097) - this node is a cross-community bridge._
- **Why does `buffer` connect `buffer` to `tag-strategy.mjs`, `createAdminClient`, `live-wrap.mjs`, `manual-edit-routes.mjs`, `live-server.mjs`, `detect-csp.mjs`, `embed-prompt.mjs`, `detect-antipatterns.mjs`, `hook.mjs`, `hook-before-edit.mjs`, `callback/route.ts`, `generate-image.mjs`?**
