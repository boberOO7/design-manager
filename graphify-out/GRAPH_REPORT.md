...
## Corpus Check
- 38 files · ~690,126 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7059 nodes · 15660 edges · 447 communities (312 shown, 135 thin omitted)
...
## Communities (447 total, 135 thin omitted)
...
Cohesion: 0.03
Nodes (129): addManualContextText(), applyEditing(), applyGlobalBarLabelState(), applyPlaceholderSizingStyles(), bufferToBase64(), buildCollapsible(), buildColorModels(), buildDesignHeader() (+121 more)

### Community 2 - "getActiveStudioMembership"
Cohesion: 0.05
Nodes (67): context(), createCandidate(), deleteCandidate(), deleteLead(), failure(), nullable(), saveLead(), startRecruitingCycle() (+59 more)

### Community 3 - "task-status.ts"
Cohesion: 0.05
Nodes (83): appendAutonomyCounterDirective(), appendDetectorFallback(), appendImageGenDirective(), appendImageToolsDirective(), appendStalenessDirective(), appendSubagentAuthorizationDirective(), appendSurfaceBriefContext(), automaticHookMode() (+75 more)

### Community 4 - "project-template-manager.tsx"
Cohesion: 0.06
Nodes (78): applyParamDefaults(), applyParamValue(), applySavedSessionMeta(), buildInsertPlaceholderSnapshotFromDom(), checkpointPayload(), clampVariantIndex(), clearHandled(), clearSession() (+70 more)
...
Cohesion: 0.05
Nodes (62): PATCH(), PATCH(), PATCH(), PATCH(), PATCH(), PATCH(), PATCH(), createProjectTask() (+54 more)
...
Cohesion: 0.05
Nodes (50): OfficeSubmissionsPage(), addSubmissionComment(), createSubmission(), InsertedCommentRow, manageSubmission(), refresh(), toggleSuggestionSupport(), InboxFilter (+42 more)
...
Cohesion: 0.07
Nodes (47): createProject(), getSelectedTemplateId(), getStageAssignees(), ProjectTemplatesPage(), Draft, Mode, PendingTask, ProjectTemplateManager() (+39 more)
...
Cohesion: 0.07
Nodes (46): ProjectMemberActionState, inviteEmployee(), isExistingAuthUserError(), removeStudioMember(), restoreStudioMember(), updateStudioMemberProfile(), AddProjectMemberForm(), ProjectTeamSection() (+38 more)
...
Cohesion: 0.06
Nodes (48): calendarQuery, route, CalendarEventFormValues, createCalendarEventFormValues(), getAllDayEventBounds(), getInclusiveAllDayEndDate(), getSiteVisitTitle(), getWorkMakeupTitle() (+40 more)
...
Cohesion: 0.08
Nodes (34): kyivToday(), OfficeAssignmentsPage(), kyivToday(), OfficeOverviewPage(), AssignmentAdminControls(), AssignmentDetailDrawer(), AssignmentRow(), AssignmentsWorkspace() (+26 more)

### Community 28 - "live-commit-manual-edits.mjs"
Cohesion: 0.07
Nodes (37): CalendarDetailHeaderIcon(), CalendarEventDetails(), CalendarPill(), dateLabel(), DayDetails(), Drawer, EventForm(), globalStyles (+29 more)
...
Cohesion: 0.05
Nodes (48): Active Studio Membership Resolver, Atomic Mutating RPCs, Avatar Storage RLS Boundary, Caller-Context Table Writes, CRM Tables, Data API Grants and RLS, Database Architecture, Database Contract Tests (+40 more)

### Community 32 - "css-cascade.mjs"
Cohesion: 0.08
Nodes (30): ProjectsPage(), ProjectCreationModal(), ProjectListControls(), controlsPath, healthKeys, ProjectItem, ProjectList(), getActiveStudioAssignees() (+22 more)
...
Cohesion: 0.09
Nodes (31): ConnectionStatus, GoogleCalendarIntegration(), isConnectionStatus(), toConnectionStatus(), updateCachedConnectionStatus(), ProfileAvatarEditor(), ProfileAvatarEditorProps, StudioMemberLifecycleControls() (+23 more)

### Community 40 - "queries/dashboard.ts"
Cohesion: 0.08
Nodes (30): Context, DELETE(), isDateOnly(), isRecord(), parseDayOff(), PATCH(), requireAdmin(), isDateOnly() (+22 more)
...
Cohesion: 0.10
Nodes (31): createOfficeAssignment(), manageOfficeAssignment(), refreshOffice(), transitionOfficeAssignment(), archiveProject(), restoreProject(), revalidateProjectRoutes(), updateProject() (+23 more)
...
Cohesion: 0.10
Nodes (31): Context, PATCH(), POST(), PATCH(), responseSchema, Context, PATCH(), CalendarSupabaseClient (+23 more)
...
Cohesion: 0.12
Nodes (21): SpaceLogoFull(), StudioFlowMark(), AppSidebar(), MobileNavigation(), OfficeShell(), tabs, CityCombobox(), isCityResult() (+13 more)
...
Cohesion: 0.11
Nodes (32): getAutomaticTaskProgress(), TaskDeadline, BOARD_COLUMNS, BoardColumnId, WritableTaskStatus, areProjectTasksEqual(), areProjectTaskSnapshotsEqual(), areTaskPeopleEqual() (+24 more)

### Community 59 - "parseAnyColor"
Cohesion: 0.07
Nodes (20): AddTaskDialog, AddTaskDialogHandle, BoardColumn(), BulkAssignmentScope, BulkDragSource, formatTaskCount(), getColumnDropId(), interactiveSelector (+12 more)

### Community 60 - "initGlobalBar"
Cohesion: 0.07
Nodes (24): ProjectStatusAction(), PageHeader(), ArchivedProject, ArchivedProjectsResult, getArchivedProjects(), ProjectRow, ActiveStudioAssignee, ProfileRow (+16 more)

### Community 61 - "live.md"
Cohesion: 0.11
Nodes (31): ProjectContextBand(), calculateOverallProjectProgress(), calculatePersonalProgress(), calculateProjectProgress(), calculateStageProgress(), calculateStageTaskProgress(), calculateTaskProgress(), calendarDate() (+23 more)
...
Cohesion: 0.12
Nodes (22): AccessUnavailablePage(), AppLayout(), generateMetadata(), SignOutButton(), AppHeader(), LanguageSelector(), ShellControl, ShellControlProps (+14 more)

### Community 65 - "queries/calendar.ts"
Cohesion: 0.13
Nodes (25): GET(), TeamPage(), getCurrentStudioTeam(), isAppLocale(), locales, resolveLocale(), CitySearchResult, GeoNamesPlace (+17 more)

### Community 66 - "cn"
Cohesion: 0.10
Nodes (23): ProjectFormModal(), ProjectForm(), ProjectFormAction, ProjectFormDefaults, ProjectCountrySelect(), ProjectMetadataDefaults, ProjectTypeSelect(), useProjectMetadataControls() (+15 more)
...
Cohesion: 0.13
Nodes (23): MyTasksPage(), getCurrentUserProfile, getMyTasks(), getProjectTaskById(), getProjectTasks(), MyTaskRow, normalizeMyTask(), normalizeProjectTask() (+15 more)
...
Cohesion: 0.11
Nodes (17): DeadlineSummary(), ProjectContextActions(), ProjectContextProject, ProjectEditModal(), LifecycleContext, ProjectLifecycleProvider(), useProjectLifecycle(), ProjectLifecycleControls() (+9 more)
...
Cohesion: 0.14
Nodes (24): getLeaderboardBonusPercent(), getLeaderboardEntryBonusPercent(), allocateRemainingStageBudget(), canCompleteAttributedTask(), CompletedProductivityAttribution, doesTaskCompletionRequireProductivityAttribution(), filterProductivityAttributionsForPeriod(), getKyivMonthBounds() (+16 more)
...
Cohesion: 0.16
Nodes (22): ArchivePage(), DashboardTaskList(), MyTasksList(), sections, makeFormValues(), TaskDetailsDrawer(), badge(), getPriorityBadgeStyle() (+14 more)
...
Cohesion: 0.14
Nodes (11): LeaderboardBonusSettings(), AvatarCropStep(), ImageDimensions, loadImageDimensions(), readFileAsDataUrl(), Button, buttonVariants, LeaderboardBonusConfig (+3 more)
...
Cohesion: 0.14
Nodes (17): Admin(), DashboardPage(), Deadlines(), Employee(), DashboardSection(), MetricStrip(), metricToneClasses, OperationalSurface() (+9 more)
...
Cohesion: 0.17
Nodes (18): DELETE(), PATCH(), POST(), PATCH(), deleteProjectTask(), revalidateTaskDeletionRoutes(), authorizeChecklistEdit(), createChecklistItem() (+10 more)
...
Cohesion: 0.12
Nodes (8): loadProfileQuery(), mocks, AccessibleProjectRow, AccessibleProjectsResult, DataMode, getLeaderboardData(), getLeaderboardForPeriod(), getLeaderboardOverviewData()
...
Cohesion: 0.17
Nodes (10): formatArea(), LeaderboardPage(), LeaderboardBonusMenu(), LeaderboardPeriodSwitcher(), canAccessLeaderboard(), LeaderboardAccessContext, hasLeaderboardBonuses(), isLeaderboardPeriod() (+2 more)
...
## Knowledge Gaps
- **1792 isolated node(s):** `fs`, `path`, `fs`, `path`, `fs` (+1787 more)
...
- **Why does `handleKeyDown()` connect `queries/index.ts` to `checks.mjs`, `lib/submissions.ts`, `project-template-manager.tsx`, `impeccable/SKILL.md`, `profile-avatar-editor.tsx`, `lib/calendar.ts`, `initPageChat`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `el()` connect `lib/calendar.ts` to `live-browser.js`, `diagnostics.ts`, `checks.mjs`, `connectSSE`, `setLiveState`, `impeccable/SKILL.md`, `modern-screenshot.umd.js`, `profile-avatar-editor.tsx`, `queries/index.ts`, `tanstack-adapter.mjs`, `svelte-ast.mjs`, `initPageChat`, `checkHtmlPatterns`, `detect-html.mjs`, `live-copy-edit-agent.mjs`?**
  _High betweenness centrality (0.099) - this node is a cross-community bridge._
- **Why does `Dialog()` connect `lib/submissions.ts` to `getActiveStudioMembership`, `cn`, `notification-presentation.ts`, `hook-admin.mjs`, `injected/index.mjs`, `detect-antipatterns-browser.js`, `task-details-drawer.tsx`, `Color Palette Management`, `queries/index.ts`, `lib/project-lifecycle.ts`, `svelte-component.mjs`, `live-commit-manual-edits.mjs`?**
...
- **Should `live-browser.js` be split into smaller, more focused modules?**
  _Cohesion score 0.03513710770514024 - nodes in this community are weakly interconnected._
- **Should `checks.mjs` be split into smaller, more focused modules?**
  _Cohesion score 0.03215359703909322 - nodes in this community are weakly interconnected._