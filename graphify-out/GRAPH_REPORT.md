...
## Corpus Check
- 343 files · ~180,047 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3178 nodes · 5296 edges · 221 communities (171 shown, 50 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 43 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `92481ca8`
...
Cohesion: 0.25
Nodes (15): ProjectDetails(), DashboardTaskList(), MyTasksList(), sections, TaskCardContent(), makeFormValues(), TaskDetailsDrawer(), TaskEditResponse (+7 more)

### Community 3 - "task.ts"
Cohesion: 0.08
Nodes (40): DELETE(), PATCH(), POST(), PATCH(), revalidateMyTasks(), revalidateTaskCreationRoutes(), updateTaskStatus(), TaskStatusControl() (+32 more)
...
Cohesion: 0.10
Nodes (32): AgendaView(), CalendarPill(), CalendarWorkspace(), dateLabel(), DayDetails(), Drawer, eventLabels, isCalendarItem() (+24 more)
...
### Community 10 - "radius"
Cohesion: 0.15
Nodes (18): $type, $value, $type, $value, $type, $value, $type, $value (+10 more)

### Community 11 - "project-task-board.tsx"
Cohesion: 0.08
Nodes (45): ProjectContextProject, ProjectWorkspace(), BoardColumn(), DraggableTaskCard(), getColumnDropId(), getColumnIdFromDropTarget(), interactiveSelector, keyboardSensor (+37 more)
...
Cohesion: 0.17
Nodes (24): AdminPage(), metadata, Availability(), AdministrationWorkspace(), AvailabilityRow(), DecisionRow(), PendingRequestRow(), RequestDrawer() (+16 more)
...
Cohesion: 0.13
Nodes (25): metadata, ProjectsPage(), labels, ProjectListControls(), ProjectProgress(), getAccessibleProjectsWithTasks(), compareNullableDate(), defaultFilters (+17 more)

### Community 21 - "types/calendar.ts"
Cohesion: 0.11
Nodes (28): CalendarPage(), metadata, validDate(), CalendarQueryInput, getCalendarData(), canTransitionTimeOff(), deduplicateCalendarItems(), getInclusiveAllDayEndDate() (+20 more)
...
### Community 27 - "cn"
Cohesion: 0.18
Nodes (13): SortableStageRow(), DashboardSection(), MetricStrip(), metricToneClasses, OperationalSurface(), MetricCard(), Panel(), getSegmentedControlItemProps() (+5 more)

### Community 28 - "server.ts"
Cohesion: 0.12
Nodes (17): ArchivedProject, ArchivedProjectsResult, ProjectRow, AccessibleProjectWithTasks, ProjectListRow, ProjectRow, updateSession(), proxy() (+9 more)
...
Cohesion: 0.14
Nodes (21): descriptions, ProjectProgressSettings(), calculatePersonalProgress(), calculateProjectProgress(), calculateTaskProgress(), calendarDate(), ChecklistItemForProgress, clampPercent() (+13 more)

### Community 39 - "lib/calendar.ts"
Cohesion: 0.10
Nodes (32): WeekView(), calendarItemTimestamp(), canAttendCalendarEvent(), compareCanonical(), DEFAULT_CALENDAR_FILTERS, filterCalendarItems(), formatTimeOffAvailabilityTitle(), getCurrentWeekTimePosition() (+24 more)
...
### Community 47 - "getActiveStudioMembership"
Cohesion: 0.08
Nodes (36): PATCH(), POST(), ArchivePage(), metadata, createProject(), metadata, NewProjectPage(), EditProjectPage() (+28 more)
...
### Community 52 - "[requestId]/route.ts"
Cohesion: 0.24
...
Cohesion: 0.18
Nodes (18): PATCH(), PATCH(), metadata, MyTasksPage(), updateTaskDetailsMutation(), AuthorizedTask, authorizeTaskMutation(), TaskMutationAuthorization (+10 more)
...
Cohesion: 0.19
Nodes (12): Admin(), DashboardPage(), Deadlines(), Employee(), EmptyState(), DASHBOARD_EMPTY_STATES, DashboardMetricTone, DashboardRole (+4 more)
...
Cohesion: 0.15
Nodes (16): DeadlineSummary(), ProjectContextBand(), ProjectDeadlines(), ProjectDesktopRow(), ProjectItem, ProjectList(), ProjectMobileCard(), getProjectHref() (+8 more)
...
- **Why does `createClient()` connect `createClient` to `queries/index.ts`, `task.ts`, `notification-bell.tsx`, `queries/project-members.ts`, `queries/dashboard.ts`, `set-password/actions.ts`, `confirm/route.ts`, `validation/calendar.ts`, `getActiveStudioMembership`, `team/actions.ts`, `administration-workspace.tsx`, `getCurrentUserProfile`, `[requestId]/route.ts`, `types/calendar.ts`, `app-header.tsx`, `project-list-presentation.ts`, `lib/project-lifecycle.ts`, `server.ts`?**
...
- **Why does `getActiveStudioMembership()` connect `getActiveStudioMembership` to `queries/index.ts`, `notification-bell.tsx`, `queries/dashboard.ts`, `team/actions.ts`, `createClient`, `getCurrentUserProfile`, `[requestId]/route.ts`, `project-list-presentation.ts`, `types/calendar.ts`, `app-header.tsx`?**
