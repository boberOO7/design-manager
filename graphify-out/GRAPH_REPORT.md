# Graph Report - design-manager  (2026-09-14)

## Corpus Check
- 994 files · ~786,028 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8280 nodes · 17767 edges · 677 communities (479 shown, 198 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 197 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fb72d19c`
...
- equipment-reference-catalog.ts
- time-off/route.ts
- productivity.ts
...
1. `createClient()` - 156 edges
2. `cn()` - 99 edges
3. `getActiveStudioMembership` - 72 edges
4. `getActiveStudioAdmin()` - 58 edges
5. `el()` - 51 edges
6. `Button` - 41 edges
7. `runHook()` - 40 edges
...
- `private.equipment_inventory_codes` --implements--> `Permanent Equipment Inventory Codes`  [EXTRACTED]
...
Cohesion: 0.04
Nodes (115): ANIMATION_VALUE_KEYWORDS, borderColorsFromStyle(), borderWidthsFromStyle(), buildHtmlPatternCorpora(), checkClippedOverflow(), checkEdgeFlushCardsDOM(), checkElementBlinkingCursorDOM(), checkElementClippedOverflow() (+107 more)

### Community 2 - "task-status.ts"
Cohesion: 0.05
Nodes (70): PATCH(), DELETE(), PATCH(), POST(), PATCH(), PATCH(), PATCH(), PATCH() (+62 more)

### Community 3 - "task-details-drawer.tsx"
Cohesion: 0.05
Nodes (61): react, react, revalidateMyTasks(), updateTaskStatus(), ChecklistTemplateManager(), createStage(), Draft, SortableStageRow() (+53 more)
...
### Community 5 - "project-task-board.tsx"
Cohesion: 0.07
Nodes (29): AddTaskDialog, AddTaskDialogHandle, BoardColumn(), BulkAssignmentScope, BulkColumnDragHandle(), BulkDragSource, DraggableTaskCard(), getColumnDropId() (+21 more)

### Community 6 - "svelte-component.mjs"
Cohesion: 0.08
...
### Community 11 - "profile-avatar-editor.tsx"
Cohesion: 0.10
Nodes (26): AvatarCropStep(), ImageDimensions, loadImageDimensions(), readFileAsDataUrl(), ProfileAvatarEditor(), ProfileAvatarEditorProps, StudioMemberLifecycleControls(), Member (+18 more)

### Community 12 - "modern-screenshot.umd.js"
Cohesion: 0.07
Nodes (63): extensions, formatReport(), fs, getFiles(), main(), parseArgs(), path, patterns (+55 more)

### Community 13 - "lib/project-progress.ts"
Cohesion: 0.08
Nodes (38): DeadlineSummary(), ProjectContextActions(), ProjectContextBand(), ProjectContextProject, useProjectLifecycle(), ProjectLifecycleControls(), ProjectStatusAction(), DraftStage (+30 more)

### Community 14 - "[projectId]/page.tsx"
Cohesion: 0.11
Nodes (26): archiveProject(), restoreProject(), revalidateProjectRoutes(), updateProject(), EditProjectPage(), addProjectMember(), getFormString(), removeProjectMember() (+18 more)

### Community 15 - "contractor-directory.tsx"
Cohesion: 0.12
...
### Community 16 - "submissions-workspace.tsx"
Cohesion: 0.10
Nodes (24): addSubmissionComment(), createSubmission(), InsertedCommentRow, manageSubmission(), refresh(), toggleSuggestionSupport(), CreateSubmissionDialog(), InboxFilter (+16 more)

### Community 17 - "createClient"
Cohesion: 0.21
Nodes (30): deleteContractor(), deleteContractorCategory(), updateContractorCategoryColor(), createOfficeAssignment(), manageOfficeAssignment(), refreshOffice(), transitionOfficeAssignment(), assignEquipment() (+22 more)

### Community 18 - "lib/calendar.ts"
Cohesion: 0.07
Nodes (50): AgendaView(), CalendarWorkspace(), MonthView(), CalendarEventRelevance, calendarItemTimestamp(), CalendarTimeOffTitleLabels, canAttendCalendarEvent(), compareCanonical() (+42 more)

### Community 19 - "doctor.mjs"
Cohesion: 0.13
Nodes (34): applyFixes(), cli(), collect(), parseArgs(), readProjectRootPatterns(), rel(), renderText(), safeRead() (+26 more)

### Community 20 - "setLiveState"
Cohesion: 0.11
...
Cohesion: 0.06
Nodes (66): ACK_EXTS, ADVISORY_RULES, applyConfigSource(), applyDetectorConfigSource(), canonicalPath(), canonicalPathCache, clampByte(), clampGroupedToBudget() (+58 more)

### Community 23 - "queries/index.ts"
Cohesion: 0.06
Nodes (41): dashboardMetrics, employeeWorkload, getAccessibleProjects(), getDashboardMetrics(), getEmployeeWorkload(), getMyTasks(), getProjectAreaProgress(), getProjectById() (+33 more)

### Community 24 - "live-accept.mjs"
Cohesion: 0.12
...
### Community 25 - "database.types.ts"
Cohesion: 0.11
Nodes (17): NotificationData, NotificationRow, updateSession(), config, proxy(), ApplicationDatabase, PublicSchema, SelectedTaskBulkFunctions (+9 more)

### Community 26 - "equipment-workspace.tsx"
Cohesion: 0.08
Nodes (45): configurationLabels(), CreateKind, EquipmentAttachPicker(), EquipmentDrawer(), EquipmentGroup(), equipmentIcons, EquipmentInventory(), EquipmentMaintenanceSummary() (+37 more)
...
### Community 29 - "cn"
Cohesion: 0.09
Nodes (30): SpaceLogoFull(), StudioFlowMark(), AppSidebar(), MobileNavigation(), AccordionSection(), AnimatedFormContent(), BinarySwitch(), CreateWorkstationDialog() (+22 more)

### Community 30 - "assignments-workspace.tsx"
Cohesion: 0.09
Nodes (22): kyivToday(), OfficeAssignmentsPage(), AssignmentAdminControls(), AssignmentsWorkspace(), AssignmentWorkflowAction(), CreateAssignmentDialog(), Filter, initialCreateState (+14 more)

### Community 31 - "calendar-workspace.tsx"
Cohesion: 0.07
Nodes (38): CalendarChipIcon(), CalendarDetailHeaderIcon(), CalendarEventDetails(), CalendarPill(), dateLabel(), DayDetails(), Drawer, globalStyles (+30 more)

### Community 32 - "live-commit-manual-edits.mjs"
Cohesion: 0.10
...
Cohesion: 0.07
Nodes (35): Context, DELETE(), isDateOnly(), isRecord(), parseDayOff(), PATCH(), requireAdmin(), isDateOnly() (+27 more)

### Community 34 - "leads-workspace.tsx"
Cohesion: 0.04
Nodes (86): context(), createCandidate(), deleteCandidate(), deleteLead(), failure(), loadLeadHistory(), nullable(), recruitingCycleParameters() (+78 more)
...
### Community 37 - "semantic-styles.ts"
Cohesion: 0.12
Nodes (27): LeadStatusPill(), DashboardTaskList(), MyTasksList(), sections, StatusColumnHeader(), TaskCardContent(), TaskDeadlineSummary(), TaskDetailsDrawer() (+19 more)

### Community 38 - "hook-admin.mjs"
Cohesion: 0.12
...
### Community 41 - "notification-presentation.ts"
Cohesion: 0.18
...
### Community 42 - "project-list-presentation.ts"
Cohesion: 0.08
Nodes (35): ProjectListControls(), controlsPath, healthKeys, PrioritySignal(), ProjectDeadlines(), ProjectDesktopRow(), ProjectItem, ProjectList() (+27 more)

### Community 43 - "detect-text.mjs"
Cohesion: 0.10
...
### Community 44 - "team/page.tsx"
Cohesion: 0.10
Nodes (31): GET(), TeamPage(), LanguageSelector(), ShellControl, ShellControlProps, getCurrentStudioTeam(), AppLocale, isAppLocale() (+23 more)

### Community 45 - "live-wrap.mjs"
Cohesion: 0.12
...
### Community 46 - "slide_search_core.py"
Cohesion: 0.09
Nodes (36): format_context(), format_result(), main(), Format a single search result for display, Format contextual recommendations for display., BM25, calculate_pattern_break(), detect_domain() (+28 more)

### Community 47 - "detect-antipatterns.mjs"
Cohesion: 0.12
...
### Community 49 - "hook-before-edit.mjs"
Cohesion: 0.11
...
### Community 51 - "validation/calendar.ts"
Cohesion: 0.07
Nodes (28): calendarQuery, route, CalendarEventInsertPayload, createCalendarEventInsertPayload(), eventInput, membership, VerifiedCalendarEventMembership, verifyCalendarEventMembership() (+20 more)

### Community 52 - "queries/dashboard.ts"
Cohesion: 0.13
Nodes (39): AdminDashboard, DashboardData, DashboardDeadline, DashboardProjectRow, DashboardTaskForDrawer, DashboardTaskRow, EmployeeDashboard, getDashboard() (+31 more)

### Community 53 - "design-parser.mjs"
Cohesion: 0.13
...
### Community 56 - "administration-workspace.tsx"
Cohesion: 0.14
Nodes (26): AdminPage(), AdministrationWorkspace(), AvailabilityRow(), DecisionRow(), PendingRequestRow(), RequestDrawer(), typeKey(), getAdministrationData() (+18 more)

### Community 57 - "Brand Guidelines v1.0"
Cohesion: 0.05
Nodes (37): 1. Color Palette, 2. Typography, 3. Logo Usage, 4. Voice & Tone, 5. Imagery Guidelines, 6. Design Components, Accessibility, AI Image Generation (+29 more)

### Community 58 - "callback/route.ts"
Cohesion: 0.15
...
### Community 61 - "scanCssTextForPulsingDot"
Cohesion: 0.14
...
### Community 62 - "checklist-autosave.ts"
Cohesion: 0.15
Nodes (15): ChecklistAutosaveStore, ChecklistMutationResult, ChecklistSnapshot, isChecklistMutationResult(), Listener, PendingUpdate, requestChecklistMutation(), stores (+7 more)
...
### Community 64 - "spacing"
Cohesion: 0.06
Nodes (34): $type, $value, $type, $value, $type, $value, $type, $value (+26 more)

### Community 65 - "impeccable/SKILL.md"
Cohesion: 0.07
...
### Community 66 - "lib/tasks.ts"
Cohesion: 0.08
Nodes (40): ProjectWorkspace(), BulkTaskContextMenu(), formatTaskCount(), ProjectTaskBoard(), makeFormValues(), getTaskDeadlinePresentation(), isTaskDeadlineOverdue(), isTaskMilestoneStatus() (+32 more)

### Community 67 - "equipment-catalog/sync.ts"
Cohesion: 0.14
...
### Community 68 - "floor-plan-view.tsx"
Cohesion: 0.13
...
Cohesion: 0.11
Nodes (41): checkBorders(), checkColors(), checkElementAIPaletteDOM(), checkElementBorders(), checkElementBordersDOM(), checkElementColors(), checkElementColorsDOM(), checkElementGlowDOM() (+33 more)

### Community 70 - "project-template-manager.tsx"
Cohesion: 0.08
Nodes (35): ProjectCreationModal(), ProjectEditModal(), ProjectFormModal(), ProjectForm(), ProjectFormAction, ProjectFormDefaults, TemplateSummary(), Draft (+27 more)

### Community 71 - "live.md"
Cohesion: 0.06
...
### Community 73 - "equipment-form.tsx"
Cohesion: 0.11
Nodes (23): EquipmentFormFields(), Section, EquipmentType, isEquipmentType(), capacity, CAPACITY_UNITS, ComputerConfiguration, computerConfigurationSchema (+15 more)
...
### Community 76 - "template-extensions.mjs"
Cohesion: 0.33
...
### Community 79 - "lib/project-lifecycle.ts"
Cohesion: 0.13
Nodes (25): PATCH(), LifecycleContext, ProjectLifecycleProvider(), ProjectLifecycleMutationResult, updateProjectLifecycleStatus(), canUpdateProjectMetadata(), canWorkOnTaskInProject(), countOpenLifecycleTasks() (+17 more)

### Community 80 - "html-token-validator.py"
Cohesion: 0.14
Nodes (24): get_context(), is_allowed_exception(), is_allowed_rgba(), is_inside_block(), load_css_variables(), main(), print_result(), print_summary() (+16 more)

### Community 81 - "ensureFile"
Cohesion: 0.48
Nodes (7): bumpEditCount(), dedupeAgainstCache(), ensureFile(), ensureSession(), findingCacheKey(), rememberFindings(), touchFile()

### Community 82 - "roots.mjs"
Cohesion: 0.16
...
### Community 87 - "live-manual-edit-evidence.mjs"
Cohesion: 0.16
Nodes (26): analyzeSourceHint(), buildCandidatesForOp(), buildContextHintsByRef(), buildManualEditEvidence(), collectSearchFiles(), countOps(), decodeBasicHtml(), escapeRegExp() (+18 more)

### Community 88 - "time-off-request.ts"
Cohesion: 0.32
Nodes (6): canTransitionTimeOff(), deriveTimeOffUpdate(), base, TimeOffAction, TimeOffActorRole, TimeOffUpdate

### Community 89 - "types/calendar.ts"
Cohesion: 0.10
Nodes (38): CalendarPage(), validDate(), CalendarQueryInput, getCalendarData(), addCalendarDays(), deduplicateCalendarItems(), getInclusiveAllDayEndDate(), getCalendarRange() (+30 more)

### Community 90 - "google-calendar/sync.ts"
Cohesion: 0.12
...
### Community 92 - "Responsive Design"
Cohesion: 0.08
...
### Community 94 - "handleManualEditActivity"
Cohesion: 0.17
...
### Community 95 - "event-validation.mjs"
Cohesion: 0.14
...
### Community 96 - "validation/equipment.ts"
Cohesion: 0.11
...
### Community 97 - "Color Palette Management"
Cohesion: 0.08
...
### Community 103 - "calendar-event-form.ts"
Cohesion: 0.12
Nodes (30): EventForm(), TimeOffForm(), CalendarEventFormValues, createCalendarEventFormValues(), getAllDayEventBounds(), getSiteVisitTitle(), getWorkMakeupTitle(), groupCalendarEventProjects() (+22 more)

### Community 104 - "collectBrowserFindings"
Cohesion: 0.13
...
### Community 106 - "resolveLiveInjectionAnchor"
Cohesion: 0.11
...
### Community 107 - "dashboard/page.tsx"
Cohesion: 0.13
Nodes (19): Admin(), Availability(), DashboardPage(), Deadlines(), Employee(), ProjectDetails(), DashboardSection(), MetricStrip() (+11 more)

### Community 108 - "Design System"
Cohesion: 0.09
...
### Community 109 - "onboard.md"
Cohesion: 0.09
Nodes (22): Assess Onboarding Needs, Context Over Ceremony, Contextual Help, Design Onboarding Experiences, Documentation & Help, Empty State Design, Feature Discovery & Adoption, Guided Tours & Walkthroughs (+14 more)

### Community 110 - "handleGo"
Cohesion: 0.07
...
### Community 111 - "manual-edit-routes.mjs"
Cohesion: 0.19
...
### Community 113 - "project.ts"
Cohesion: 0.06
Nodes (51): ArchivePage(), CrmCandidatesPage(), CrmLeadsPage(), createProject(), createProjectFromLead(), createProjectRecord(), getSelectedTemplateId(), getStageAssignees() (+43 more)

### Community 114 - "queries/tasks.ts"
Cohesion: 0.11
Nodes (22): PATCH(), PATCH(), mocks, PATCH(), MyTasksPage(), bulkAssignSelectedTasksMutation(), bulkMoveTaskStatusesMutation(), bulkSetSelectedTaskDeadlineMutation() (+14 more)

### Community 115 - "collectVisualContrastCandidates"
Cohesion: 0.13
...
### Community 117 - "notification-bell.tsx"
Cohesion: 0.21
Nodes (19): iconFor(), NotificationBell(), notificationIcon(), NotificationRow, playNotificationSound(), RealtimeNotificationToast(), NotificationItem, formatNotificationRelativeTime() (+11 more)

### Community 118 - "color"
Cohesion: 0.15
Nodes (21): $type, $value, $type, $value, 500, 600, blue, green (+13 more)

### Community 119 - "GSAP Core"
Cohesion: 0.10
...
### Community 123 - "queries/equipment.ts"
Cohesion: 0.15
...
### Community 124 - "project-activity-section.tsx"
Cohesion: 0.21
...
### Community 125 - "generate-slide.py"
Cohesion: 0.15
Nodes (19): _e(), generate_chart_slide(), generate_cta_slide(), generate_deck(), generate_metrics_slide(), generate_problem_slide(), generate_solution_slide(), generate_testimonial_slide() (+11 more)

### Community 126 - "fontSize"
Cohesion: 0.12
Nodes (16): $type, $value, $type, $value, $type, $value, $type, $value (+8 more)

### Community 127 - "DesignSystemGenerator"
Cohesion: 0.14
...
### Community 128 - "dialog.tsx"
Cohesion: 0.10
Nodes (24): ConnectionStatus, GoogleCalendarIntegration(), isConnectionStatus(), toConnectionStatus(), updateCachedConnectionStatus(), tabs, getAppScrollContainer(), getScrollbarWidth() (+16 more)

### Community 129 - "staleness-deep.mjs"
Cohesion: 0.18
...
### Community 130 - "Asset Organization Guide"
Cohesion: 0.11
...
### Community 134 - "tanstack-adapter.mjs"
Cohesion: 0.20
...
### Community 136 - "contractors/actions.ts"
Cohesion: 0.23
...
### Community 137 - "lib/submissions.ts"
Cohesion: 0.18
Nodes (17): SubmissionRow(), SubmissionWorkflowAction(), canRejectSubmission(), getAllowedNextStatuses(), getPrimarySubmissionAction(), getPrimarySubmissionStatus(), isSubmissionStatus(), isSubmissionType() (+9 more)

### Community 138 - "Brand Consistency Checklist"
Cohesion: 0.11
Nodes (17): Audit Frequency, Brand Consistency Checklist, Channel Audit, Collateral, Colors, Common Issues, Email, Imagery (+9 more)

### Community 139 - "Color Semantics"
Cohesion: 0.11
...
### Community 142 - "sveltekit-adapter.mjs"
Cohesion: 0.24
...
Cohesion: 0.08
Nodes (30): AccessUnavailablePage(), ProjectMemberActionState, LoginPage(), LeaderboardBonusSettings(), SignOutButton(), AppHeader(), LeaderboardBonusMenu(), AddProjectMemberForm() (+22 more)

### Community 146 - "context-signals.mjs"
Cohesion: 0.18
Nodes (17): extractPlatform(), extractSectionValue(), loadContext(), loadNativePlatformReferences(), safeRead(), cli(), COMMON_DEV_PORTS, devServerSignals() (+9 more)
...
### Community 148 - "detect-utils.mjs"
Cohesion: 0.28
...
### Community 149 - "design_system.py"
Cohesion: 0.15
...
### Community 150 - "20260911221152_equipment_inventory_identity.sql"
Cohesion: 0.36
...
### Community 154 - "team/actions.ts"
Cohesion: 0.06
Nodes (44): inviteEmployee(), isExistingAuthUserError(), updateStudioMemberProfile(), requestPasswordRecovery(), ForgotPasswordForm(), CityCombobox(), isCityResult(), SearchState (+36 more)

### Community 155 - "serve-question.mjs"
Cohesion: 0.13
Nodes (8): esc(), localImages, page(), payloadPath, portArg, QUESTION_DIR, server, timeoutSec

### Community 156 - "Writing Guidelines for Postgres References"
Cohesion: 0.12
Nodes (15): 1. Concrete Transformation Patterns, 2. Error-First Structure, 3. Quantified Impact, 4. Self-Contained Examples, 5. Semantic Naming, Code Example Standards, Comments, Impact Level Guidelines (+7 more)

### Community 157 - "20260904120000_internal_submissions.sql"
Cohesion: 0.17
...
### Community 161 - "Copywriting Formulas"
Cohesion: 0.13
Nodes (14): AIDA (Attention-Interest-Desire-Action), Before-After-Bridge, Contrast Patterns, Copywriting Formulas, Core Formulas, Cost of Inaction, FAB (Features-Advantages-Benefits), Formula-to-Slide Mapping (+6 more)

### Community 162 - "core.py"
Cohesion: 0.19
...
### Community 165 - "extract-colors.cjs"
Cohesion: 0.22
Nodes (11): calculateCompliance(), colorDistance(), displayPalette(), extractHexColors(), findNearestBrandColor(), fs, generateImageMagickCommand(), hexToRgb() (+3 more)

### Community 166 - "validate-asset.cjs"
Cohesion: 0.25
Nodes (13): checkManifest(), formatBytes(), formatOutput(), fs, main(), parseFilename(), path, RULES (+5 more)

### Community 167 - "Tailwind Integration"
Cohesion: 0.14
...
### Community 168 - "Impeccable Asset Producer"
Cohesion: 0.14
...
### Community 171 - "sampleCssBackground"
Cohesion: 0.18
...
### Community 172 - "Layout Patterns"
Cohesion: 0.14
Nodes (13): Card Styles, Component Variants, CSS Structures, Feature Grid (3 columns), Layout Decision Flow, Layout Patterns, Layout Selection by Use Case, Metric Styles (+5 more)

### Community 173 - "equipment-form.spec.ts"
Cohesion: 0.18
Nodes (13): page, admin, captureContainedTransition(), choose(), localSql(), login(), open(), panel() (+5 more)

### Community 174 - "StudioFlow product specification"
Cohesion: 0.14
...
### Community 175 - "equipment-reference-catalog.ts"
Cohesion: 0.29
Nodes (7): GET(), EquipmentCatalogCombobox(), mocks, equipmentCatalogResultsSchema, EquipmentCatalogSearch, equipmentCatalogSearchSchema, equipmentManufacturerSuggestions()

### Community 176 - "time-off/route.ts"
Cohesion: 0.27
Nodes (10): CalendarSupabaseClient, getVerifiedTimeOffMembership(), POST(), VerifiedTimeOffMembership, CalendarCreatorRole, canCreateTimeOffRequestType(), getCreatableCalendarEventTypes(), getCreatableTimeOffRequestTypes() (+2 more)

### Community 177 - "productivity.ts"
Cohesion: 0.09
Nodes (39): BonusBadge(), formatArea(), LeaderboardPage(), LeaderboardPeriodSwitcher(), getLeaderboardData(), getLeaderboardForPeriod(), getLeaderboardOverviewData(), getStudioLeaderboardBonusConfig() (+31 more)

### Community 178 - "calendar-event-types.ts"
Cohesion: 0.24
Nodes (8): appLayout, globalStyles, source, CALENDAR_EVENT_DETAIL_CONFIG, CALENDAR_EVENT_TYPE_CONFIG, CalendarEventDetailConfig, CalendarEventDetailSection, CalendarEventTypeConfig

### Community 179 - "theme-switch.tsx"
Cohesion: 0.14
Nodes (16): geistMono, geistSans, viewport, applyTheme(), getServerThemeSnapshot(), getThemeSnapshot(), subscribeToTheme(), syncThemeColor() (+8 more)

### Community 180 - "20260730120100_task_progress_checklists.sql"
Cohesion: 0.23
...
### Community 181 - "brand/references/update.md"
Cohesion: 0.15
...
### Community 183 - "design-tokens-starter.json"
Cohesion: 0.15
Nodes (12): component, $type, $value, dark, semantic, $schema, $type, $value (+4 more)

### Community 184 - "GSAP with React"
Cohesion: 0.15
...
### Community 185 - "Scan mode (approach C: auto-extract, then confirm descriptive language)"
Cohesion: 0.15
...
### Community 187 - "frameworks/index.mjs"
Cohesion: 0.17
...
### Community 189 - "server.ts"
Cohesion: 0.13
Nodes (25): Context, DELETE(), PATCH(), POST(), PATCH(), responseSchema, Context, PATCH() (+17 more)

### Community 190 - "20260813143000_per_task_studio_member_removal.sql"
Cohesion: 0.24
...
### Community 191 - "Primitive Tokens"
Cohesion: 0.17
...
### Community 193 - "GSAP Performance"
Cohesion: 0.17
...
### Community 195 - "Simplify the Design"
Cohesion: 0.17
...
### Community 196 - "Hardening Dimensions"
Cohesion: 0.17
...
### Community 199 - "generation-preflight.mjs"
Cohesion: 0.30
...
### Community 201 - "google-calendar/diagnostics.ts"
Cohesion: 0.33
...
### Community 202 - "20260728153858_calendar_foundation.sql"
Cohesion: 0.24
...
### Community 204 - "20260910221602_equipment_maintenance.sql"
Cohesion: 0.24
...
### Community 215 - "detect-csp.mjs"
Cohesion: 0.35
Nodes (10): detectCsp(), INLINE_HEADER_SIGNALS, LAYOUT_EXTS, MONOREPO_HELPER_SIGNALS, NUXT_ROUTE_RULES_SIGNALS, NUXT_SECURITY_SIGNALS, SCAN_EXTS, SKIP_DIRS (+2 more)

### Community 216 - "embed-prompt.mjs"
Cohesion: 0.20
Nodes (7): args, buf, crc32(), crcTable, file, pngChunk(), readMode

### Community 217 - "palette.mjs"
Cohesion: 0.24
Nodes (7): args, buildWeights(), hashUnit(), pickSeed(), seed, SEEDS, weightedPick()

### Community 218 - "google-calendar-integration.test.ts"
Cohesion: 0.18
Nodes (9): callbackRoute, connectRoute, disconnectRoute, en, integrationUi, migration, sync, tokenCrypto (+1 more)

### Community 219 - "lib/office-assignments.ts"
Cohesion: 0.31
Nodes (11): kyivToday(), OfficeOverviewPage(), AssignmentDetailDrawer(), AssignmentRow(), statusStyle(), getAllowedOfficeAssignmentStatuses(), getPrimaryOfficeAssignmentStatus(), isOfficeAssignmentOverdue() (+3 more)

### Community 220 - "20260819110000_calendar_event_invitations.sql"
Cohesion: 0.31
...
### Community 221 - "20260904135441_office_assignments.sql"
Cohesion: 0.24
...
### Community 223 - "Component Tokens"
Cohesion: 0.20
...
### Community 224 - "generate-tokens.cjs"
Cohesion: 0.36
Nodes (9): flattenTokens(), fs, generateCSS(), generateTailwind(), main(), parseArgs(), path, resolveReference() (+1 more)

### Community 225 - "button"
Cohesion: 0.20
Nodes (10): fg, font-size, hover-bg, button, $type, $value, $type, $value (+2 more)

### Community 226 - "CORE DIRECTIVE: AWWWARDS-LEVEL DESIGN ENGINEERING"
Cohesion: 0.20
...
### Community 228 - "detect-html.mjs"
Cohesion: 0.09
Nodes (32): collectStaticCssText(), checkStaticPageTypography(), detectHtml(), STATIC_ELEMENT_RULES, checkCreamPalette(), checkElementGlow(), checkElementMotion(), checkElementMotionDOM() (+24 more)
...
### Community 230 - "Section Definitions"
Cohesion: 0.20
...
### Community 232 - "queries/submissions.ts"
Cohesion: 0.18
Nodes (11): OfficeSubmissionsPage(), SubmissionsWorkspace(), CommentRow, getSubmissionsData(), person(), SubmissionComment, SubmissionItem, SubmissionRow (+3 more)

### Community 233 - "legal-document.tsx"
Cohesion: 0.24
Nodes (5): metadata, metadata, LegalDocument(), LegalDocumentProps, LegalSection

### Community 234 - "candidates-workspace.tsx"
Cohesion: 0.10
Nodes (26): CandidateCycleFields(), CandidateDetail(), CandidatesWorkspace(), formatDate(), formatDateTime(), isNestedInteractiveTarget(), PositionField(), positionLabel() (+18 more)

### Community 235 - "google-calendar-automatic-sync.test.ts"
Cohesion: 0.20
Nodes (8): createRoute, cronRoute, eventRoute, grantMigration, invitationRoute, migration, queue, sync

### Community 236 - "20260728214907_in_app_notifications.sql"
Cohesion: 0.24
...
### Community 237 - "20260818170000_project_stage_columns_and_internal_review.sql"
Cohesion: 0.22
...
### Community 238 - "20260827120000_task_collaborators.sql"
Cohesion: 0.27
...
### Community 239 - "20260908144506_create_crm_foundation.sql"
Cohesion: 0.27
...
### Community 244 - "Common Cognitive Load Violations"
Cohesion: 0.22
...
### Community 249 - "Data API Grants and RLS"
Cohesion: 0.15
...
### Community 254 - "project-form.contract.test.ts"
Cohesion: 0.22
Nodes (8): actionPath, contextPath, editActionPath, editModalPath, formPath, metadataControlsPath, modalPath, sharedModalPath

### Community 255 - "parseDateOnly"
Cohesion: 0.32
Nodes (11): parseDateOnly(), startOfMondayWeek(), annualCalendarDate(), buildCalendarSystemEvents(), CalendarSystemEventMember, isLeapYear(), monthlyCalendarDate(), rangeMonths() (+3 more)

### Community 256 - "time-off-stabilization-migration.test.ts"
Cohesion: 0.22
Nodes (7): foundation, insertPolicyFix, migration, migrationNames, migrations, migrationsDirectory, notificationShapeFix

### Community 257 - "20260825150000_project_stage_configuration.sql"
Cohesion: 0.28
...
### Community 258 - "20260829170000_add_business_trip_participants.sql"
Cohesion: 0.28
...
### Community 259 - "20260910193120_equipment_domain_foundation.sql"
Cohesion: 0.31
...
### Community 262 - "Persona-Based Design Testing"
Cohesion: 0.25
Nodes (8): 1. Impatient Power User: "Alex", 2. Confused First-Timer: "Jordan", 3. Accessibility-Dependent User: "Sam", 4. Deliberate Stress Tester: "Riley", 5. Distracted Mobile User: "Casey", Persona-Based Design Testing, Project-Specific Personas, Selecting Personas

### Community 263 - "doctor.md"
Cohesion: 0.25
...
### Community 264 - "Extract Flow"
Cohesion: 0.25
Nodes (7): Extract Flow, Step 1: Discover the Design System, Step 2: Identify Patterns, Step 3: Plan Extraction, Step 4: Extract & Enrich, Step 5: Migrate, Step 6: Document

### Community 265 - "time-off-compensation.ts"
Cohesion: 0.31
...
### Community 266 - "expandScanTargets"
Cohesion: 0.36
...
### Community 268 - "office-assignment.ts"
Cohesion: 0.28
Nodes (7): OFFICE_ASSIGNMENT_PRIORITIES, OFFICE_ASSIGNMENT_STATUSES, createOfficeAssignmentSchema, manageOfficeAssignmentSchema, OfficeAssignmentActionState, optionalDate, transitionOfficeAssignmentSchema

### Community 269 - "search"
Cohesion: 0.36
...
### Community 271 - "Productivity and progress"
Cohesion: 0.25
...
### Community 276 - "20260728145920_project_lifecycle_workflow.sql"
Cohesion: 0.32
...
### Community 278 - "20260729200758_project_activity_history.sql"
Cohesion: 0.32
...
### Community 279 - "20260805212420_structured_project_metadata.sql"
Cohesion: 0.36
...
### Community 280 - "20260821130000_project_templates.sql"
Cohesion: 0.36
...
### Community 281 - "20260902140546_google_calendar_automatic_reconciliation.sql"
Cohesion: 0.29
...
### Community 283 - "20260910112451_review_note_privacy.sql"
Cohesion: 0.36
...
### Community 284 - "20260912124803_equipment_reference_catalog.sql"
Cohesion: 0.25
Nodes (3): public.equipment_catalog_manufacturers, public.equipment_catalog_products, public.equipment_catalog_sync_state

### Community 285 - "20260913214647_add_crm_follow_up_state.sql"
Cohesion: 0.36
...
### Community 287 - "Cognitive Load Assessment"
Cohesion: 0.29
Nodes (7): Cognitive Load Assessment, Cognitive Load Checklist, Extraneous Load: Bad Design, Germane Load: Learning Effort, Intrinsic Load: The Task Itself, The Working Memory Rule, Three Types of Cognitive Load

### Community 288 - "Impeccable Manual Edit Applier"
Cohesion: 0.29
...
### Community 290 - "HTML Slide Template"
Cohesion: 0.29
Nodes (6): Animation Classes, Background Images, Base Structure, Chart.js Integration, CSS Variables Reference, HTML Slide Template

### Community 291 - "detect_domain"
Cohesion: 0.43
Nodes (3): detect_domain(), Auto-detect the most relevant domain from query. Matches are weighted by…, TestDomainDetection

### Community 292 - "Office Submissions"
Cohesion: 0.29
...
### Community 293 - "Database Architecture"
Cohesion: 0.38
...
### Community 294 - "Equipment reference catalog"
Cohesion: 0.29
...
### Community 295 - "Architecture overview"
Cohesion: 0.29
...
### Community 296 - "Non-Project Studio Work"
Cohesion: 0.18
...
### Community 297 - "Equipment Inventory"
Cohesion: 0.22
...
### Community 302 - "20260802192102_studio_checklist_templates.sql"
Cohesion: 0.38
...
### Community 303 - "20260813120000_studio_member_lifecycle.sql"
Cohesion: 0.52
...
### Community 304 - "20260817172631_leaderboard_bonus_rules.sql"
Cohesion: 0.38
...
### Community 305 - "20260821100000_stage_progress_methods.sql"
Cohesion: 0.43
...
### Community 306 - "20260830130000_google_calendar_phase_one.sql"
Cohesion: 0.38
...
### Community 308 - "bolder.md"
Cohesion: 0.33
Nodes (5): Before you finish, Scope is sovereign, The amplification, The skeleton test, Why it reads flat

### Community 309 - "normalizeGitHubEvent"
Cohesion: 0.38
...
### Community 310 - "Slides"
Cohesion: 0.33
Nodes (5): References (Knowledge Base), Routing, Slides, Subcommands, When to Use

### Community 311 - "Supabase Postgres Best Practices"
Cohesion: 0.33
Nodes (5): How to Use, References, Rule Categories by Priority, Supabase Postgres Best Practices, When to Apply

### Community 312 - "graphify reference: query, path, explain"
Cohesion: 0.33
Nodes (5): For /graphify explain, For /graphify path, graphify reference: query, path, explain, Step 0 — Constrained query expansion (REQUIRED before traversal), Step 1 — Traversal

### Community 313 - "leads-workspace.test.ts"
Cohesion: 0.33
Nodes (5): actionsPath, cityComboboxPath, metadataControlsPath, projectFormPath, workspacePath

### Community 314 - "crm-lead-lifecycle-migration.test.ts"
Cohesion: 0.33
Nodes (5): backfillMigration, enumMigration, markAllRoute, migration, notificationsQuery

### Community 318 - "20260909104850_add_crm_lead_lifecycle_behavior.sql"
Cohesion: 0.47
...
### Community 320 - "vercel.json"
Cohesion: 0.33
Nodes (5): crons, main, git, deploymentEnabled, $schema

### Community 321 - "Brand Guidelines Template"
Cohesion: 0.40
...
### Community 324 - "radius"
Cohesion: 0.60
Nodes (5): radius, radius, radius, $type, $value

### Community 325 - "Permissions"
Cohesion: 0.40
Nodes (5): Access matrix, Canonical sources, Identity model, Invariants, Permissions

### Community 326 - "Q: Trace Office submission comments from database schema and RLS through server mutation and client drawer Realtime synchronization"
Cohesion: 0.40
...
### Community 327 - "Q: Fix the leaderboard previous period leader calculation."
Cohesion: 0.40
...
### Community 338 - "20260829180000_add_meeting_presentation_mode.sql"
Cohesion: 0.50
...
### Community 341 - "20260909113540_link_crm_leads_to_projects.sql"
Cohesion: 0.60
...
### Community 349 - "validate_data.py"
Cohesion: 0.83
...
### Community 353 - "equipment-workspace.test.ts"
Cohesion: 0.25
Nodes (7): actions, cron, form, query, shell, styles, workspace

### Community 354 - "contractor-permissions.contract.test.ts"
Cohesion: 0.50
Nodes (3): actionsPath, directoryPath, pagePath

### Community 355 - "stage-configuration-controls.test.ts"
Cohesion: 0.50
Nodes (3): boardPath, dialogPath, mutationPath

### Community 356 - "task-details-drawer.test.ts"
Cohesion: 0.50
Nodes (3): collaboratorControlPath, deadlineEditorPath, drawerPath

### Community 358 - "auth-autocomplete.test.ts"
Cohesion: 0.50
Nodes (3): loginPath, recoveryPath, resetPath

### Community 359 - "crm-lead-follow-up-migration.test.ts"
Cohesion: 0.50
Nodes (3): enumMigration, stateMigration, statusSyncMigration

### Community 360 - "crm-lead-metadata-migration.test.ts"
Cohesion: 0.50
Nodes (3): constraintMigrationPath, currencyMigrationPath, migrationPath

### Community 361 - "project-city-geonames-mutation.test.ts"
Cohesion: 0.50
Nodes (3): createActionPath, editActionPath, projectQueryPath

### Community 362 - "public-table-privileges-migration.test.ts"
Cohesion: 0.50
Nodes (3): migrationPath, taskDeleteMigrationPath, taskStatusInsertMigrationPath

### Community 364 - "20260806175022_add_project_city_geonames_id.sql"
Cohesion: 0.67
Nodes (3): enforce_structured_project_metadata_before_update, private.enforce_structured_project_metadata(), public.projects

### Community 368 - "20260818180000_canonical_project_types.sql"
Cohesion: 0.67
Nodes (3): enforce_structured_project_metadata_before_update, private.enforce_structured_project_metadata(), public.projects

### Community 375 - "20260910120551_task_deadline_completion_history.sql"
Cohesion: 0.67
...
### Community 383 - "primary-foreground"
Cohesion: 0.67
...
### Community 385 - "secondary-foreground"
Cohesion: 0.67
Nodes (3): secondary-foreground, $type, $value

### Community 662 - "How to Use This Skill"
Cohesion: 0.29
...
### Community 667 - "queries/project-stage-columns.ts"
Cohesion: 0.14
Nodes (20): PATCH(), PATCH(), logStageColumnsSaveError(), updateProjectStageConfiguration(), updateProjectStageSettings(), AccessibleProjectWithTasks, getAccessibleProjectsWithTasks(), ProfileRow (+12 more)

### Community 668 - "shadow"
Cohesion: 0.18
Nodes (15): lg, sm, $type, $value, $type, $value, shadow, lg (+7 more)

### Community 674 - "source-search.mjs"
Cohesion: 0.50
Nodes (4): matchesTemplateExtension(), NEVER_SOURCE_DIRS, SOURCE_SEARCH_DIRS, walk()

### Community 675 - "padding-x"
Cohesion: 0.67
...
## Knowledge Gaps
- **2105 isolated node(s):** `fs`, `path`, `fs`, `path`, `fs` (+2100 more)
...
- **Why does `buffer` connect `callback/route.ts` to `tag-strategy.mjs`, `equipment-catalog/sync.ts`, `live-server.mjs`, `live-wrap.mjs`, `detect-antipatterns.mjs`, `manual-edit-routes.mjs`, `hook-before-edit.mjs`, `createAdminClient`, `detect-csp.mjs`, `embed-prompt.mjs`, `hook.mjs`, `generate-image.mjs`?**
  _High betweenness centrality (0.095) - this node is a cross-community bridge._
- **Why does `handleKeyDown()` connect `setLiveState` to `live-browser.js`, `dialog.tsx`, `lib/tasks.ts`, `semantic-styles.ts`, `connectSSE`, `el`, `initPageChat`, `initGlobalBar`?**
  _High betweenness centrality (0.095) - this node is a cross-community bridge._
- **Why does `el()` connect `el` to `live-browser.js`, `checks.mjs`, `css-cascade.mjs`, `detect-html.mjs`, `svelte-ast.mjs`, `injected/index.mjs`, `collectBrowserFindings`, `detect-antipatterns-browser.js`, `design-system.mjs`, `constants.mjs`, `connectSSE`, `collectVisualContrastCandidates`, `setLiveState`, `initPageChat`, `initGlobalBar`?**
...
- **Should `checks.mjs` be split into smaller, more focused modules?**
  _Cohesion score 0.036216137911053166 - nodes in this community are weakly interconnected._