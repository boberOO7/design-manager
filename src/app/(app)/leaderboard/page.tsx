...
import { getKyivPeriodLabel, getKyivPeriodRangeLabel, getLeaderboardBonusPercent, getLeaderboardTotals, isLeaderboardPeriod, type LeaderboardPeriod } from "@/lib/productivity";
...
export default async function LeaderboardPage({ searchParams }: { searchParams: Promise<{ period?: string }> }) {
  ...
  const monthlyBonusesApply = period === "month";
