...
describe("dashboard calculations", () => {
  ...
  it("sorts attention projects and does not duplicate project summaries", () => {
    ...
    const items = getProjectsRequiringAttention(projects, [task({ id: "t1", due_date: "2026-07-20" }), task({ id: "t2", priority: "urgent" }), task({ id: "t3", project_id: "p2", project: { id: "p2", name: "Beta" }, priority: "high" })], today);
