...
function model(): AdministrationModel { return { leaderboardBonusConfig: { enabled: true, rules: [{ place: 1, bonusPercent: 15 }] }, today: "2026-07-28", upcomingEnd: getUpcomingEndDate("2026-07-28"), pendingRequests: [request()], upcomingAbsences: [], recentDecisions: [], team: { activeMembers: 4, administrators: 1, inactiveMembers: 2 } }; }
