      ...
      {groups.map(group => {
        ...
        return <section key={group.direction} data-category-direction={group.direction} className={`overflow-hidden rounded-[var(--ui-radius-panel)] border border-t-2 border-[var(--ui-border)] bg-[var(--ui-surface)] ${group.border}`}>
          ...
          <ul className="divide-y divide-[var(--ui-border)]">{items.map(category => {
            ...
            return <li key={category.id} className="group flex min-h-14 items-center justify-between gap-3 px-4 py-2.5 transition-colors motion-reduce:transition-none hover:bg-[var(--ui-surface-subtle)] has-[:focus-visible]:bg-[var(--ui-surface-subtle)]">
              ...
              <div className="flex shrink-0 items-center gap-1 opacity-100 transition-opacity duration-150 motion-reduce:transition-none md:pointer-fine:opacity-0 md:pointer-fine:group-hover:opacity-100 md:pointer-fine:group-has-[:focus-visible]:opacity-100">
