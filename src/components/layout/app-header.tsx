...
export async function AppHeader({ crmAttentionCount, joinedAt, leaderboardVisibleToEmployees, profile, systemRole }: { crmAttentionCount: number; joinedAt: string | null; leaderboardVisibleToEmployees: boolean; profile: Profile | null; systemRole: SystemRole }) {
