      ...
      <div className="min-h-0 overflow-y-auto p-4 sm:p-6"><input name="userId" type="hidden" value={userId} />
        <fieldset disabled={pending}>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <label className="block text-sm font-medium text-[var(--ui-text-secondary)]">{t("firstName")}<Input autoComplete="given-name" className="mt-2 aria-invalid:border-[var(--ui-danger-border)]" defaultValue={firstName} name="firstName" required {...errorAttributes("firstName")} />{fieldError("firstName") ? <p id="team-profile-firstName-error" className="mt-1.5 text-sm text-[var(--ui-danger-text)]">{t("correctFields")}</p> : null}</label>
            <label className="block text-sm font-medium text-[var(--ui-text-secondary)]">{t("lastName")}<Input autoComplete="family-name" className="mt-2 aria-invalid:border-[var(--ui-danger-border)]" defaultValue={lastName} name="lastName" required {...errorAttributes("lastName")} />{fieldError("lastName") ? <p id="team-profile-lastName-error" className="mt-1.5 text-sm text-[var(--ui-danger-text)]">{t("correctFields")}</p> : null}</label>
