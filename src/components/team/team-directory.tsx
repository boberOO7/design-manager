...
type Member = { avatar_url: string | null; birth_date: string | null; birthdayLabel: string; city: string | null; city_geonames_id: number | null; country_code: string | null; editableJobTitle: string | null; full_name: string; id: string; is_active: boolean; jobTitle: string | null; joined_at: string | null; location: string | null; removed_at: string | null; roleLabel: string; systemRole: "admin" | "employee" };
