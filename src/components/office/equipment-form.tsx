...
export function EquipmentFormFields({ item, initialType, showMaintenanceFields = true, workstations }: { item?: EquipmentItem; initialType?: EquipmentType; showMaintenanceFields?: boolean; workstations: WorkstationItem[] }) {
  const t = useTranslations("Equipment");
