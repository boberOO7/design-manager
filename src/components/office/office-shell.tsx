...
import { Boxes, ClipboardCheck, LayoutDashboard, MessageSquareText, MonitorCog, Plus } from "lucide-react";
...
const tabs = [
  { href: "/office", key: "overview", icon: LayoutDashboard, adminOnly: false },
  { href: "/office/submissions", key: "submissions", icon: MessageSquareText, adminOnly: false },
  { href: "/office/assignments", key: "assignments", icon: ClipboardCheck, adminOnly: false },
  { href: "/office/equipment", key: "equipment", icon: MonitorCog, adminOnly: true },
] as const;
