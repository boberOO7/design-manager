...
describe("Equipment localization", () => {
  it("keeps English and Ukrainian Equipment keys in parity", () => {
    ...
    for (const key of ["title", "description", "views.workstations", "views.inventory", "inventory.office", "inventory.allTypes", "inventory.noMatches", "workstation.types.office", "workstation.types.remote", "workstation.form.type", "actions.changeCode", "actions.retry", "maintenance.saveSchedule", "configuration.save", "autocomplete.show", "autocomplete.empty", "autocomplete.useValue", "views.maintenance", "actions.addWorkstation", "actions.createWorkstations", "actions.addEquipment", "actions.more", "workstation.numberLabel", "workstation.unassigned", "workstation.actions.renumber", "workstation.form.quantity", "workstation.form.decreaseQuantity", "workstation.form.increaseQuantity", "workstation.form.decreaseNumber", "workstation.form.increaseNumber", "workstation.form.numberConflict", "workstation.form.assignEmployees", "form.displayName", "form.workstation", "form.identificationSummary", "form.assetTagDescription", "form.assetTagNumber", "form.decreaseAssetTag", "form.increaseAssetTag", "form.codeUnavailable", "assignment.attachComputer", "assignment.attachMonitor", "assignment.attachPeripheral", "assignment.search", "assignment.noMatches", "assignment.moveConfirm", "maintenance.queueTitle", "maintenance.summaryTitle", "maintenance.openWorkspace", "maintenance.upcoming", "maintenance.overdue", "service.send", "service.complete", "history.title", "history.types.regular_maintenance", "history.types.repair", "history.types.upgrade", "errors.numberConflict", "errors.employeeAssigned", "errors.permission"] as const) {
