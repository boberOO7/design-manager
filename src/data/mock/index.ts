...
export const studioTasks: Task[] = [
  { id: "task-1", project_id: "project-1", title: "Finalize zoning plan", description: "Confirm circulation and daylight studies", stage: "stage_2", status: "in_progress", priority: "high", assignee_id: "user-anna", created_by: "user-admin", start_date: "2026-07-01", due_date: "2026-07-24", completed_at: null, created_at: "2026-06-30T09:00:00.000Z", updated_at: "2026-07-12T09:00:00.000Z" },
  { id: "task-2", project_id: "project-1", title: "Prepare furniture schedule", description: null, stage: "stage_1", status: "todo", priority: "normal", assignee_id: "user-oleksandr", created_by: "user-admin", start_date: "2026-07-05", due_date: "2026-07-26", completed_at: null, created_at: "2026-07-02T09:00:00.000Z", updated_at: "2026-07-02T09:00:00.000Z" },
  { id: "task-3", project_id: "project-2", title: "Review render set", description: "Share updates with client", stage: "stage_4", status: "completed", priority: "high", assignee_id: "user-maria", created_by: "user-admin", start_date: "2026-06-10", due_date: "2026-06-18", completed_at: "2026-06-18", created_at: "2026-06-08T09:00:00.000Z", updated_at: "2026-06-18T14:00:00.000Z" },
  { id: "task-4", project_id: "project-3", title: "Close out final punch list", description: null, stage: "stage_4", status: "completed", priority: "low", assignee_id: "user-anna", created_by: "user-admin", start_date: "2025-01-15", due_date: "2025-02-10", completed_at: "2025-02-10", created_at: "2024-12-20T09:00:00.000Z", updated_at: "2025-02-10T14:00:00.000Z" },
];
