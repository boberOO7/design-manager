...
| Finance settings, accounts, cash ledger/FX, categories, expected items, settlement, project agreements/revenue and unapplied money | Active profile and active studio admin; RLS, guarded RPCs and caller-context views, including archived projects | No access, including the Project Finance tab |
